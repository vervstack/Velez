...
func RegisterVpnApiHandlerServer(ctx context.Context, mux *runtime.ServeMux, server VpnApiServer) error {
	mux.Handle(http.MethodGet, pattern_VpnApi_ListNamespaces_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		annotatedContext, err := runtime.AnnotateIncomingContext(ctx, mux, req, "/velez_api.VpnApi/ListNamespaces", runtime.WithHTTPPathPattern("/api/vpn/namespaces"))
		if err != nil {
...
func RegisterVpnApiHandlerClient(ctx context.Context, mux *runtime.ServeMux, client VpnApiClient) error {
	mux.Handle(http.MethodGet, pattern_VpnApi_ListNamespaces_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		defer cancel()
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		annotatedContext, err := runtime.AnnotateContext(ctx, mux, req, "/velez_api.VpnApi/ListNamespaces", runtime.WithHTTPPathPattern("/api/vpn/namespaces"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
...
var (
	pattern_VpnApi_ListNamespaces_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"api", "vpn", "namespaces"}, ""))
)
