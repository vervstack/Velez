...
## Corpus Check
- 570 files · ~254,650 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 6338 nodes · 10372 edges · 739 communities (361 shown, 378 thin omitted)
- Extraction: 96% EXTRACTED · 4% INFERRED · 0% AMBIGUOUS · INFERRED: 462 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `ba222246`
...
1. `T` - 155 edges
2. `NodeClients` - 55 edges
3. `file_service_api_proto_rawDescGZIP()` - 47 edges
4. `newFakeDocker()` - 42 edges
5. `useToaster` - 34 edges
6. `file_velez_api_proto_rawDescGZIP()` - 32 edges
...
- **Velez Configuration Environment Variable Schema** — config_config_config_config_config_config_config_config_config_config_config_config_configyaml, config_configtemplate, docs_configuration [INFERRED 0.90]
...
## Communities (739 total, 378 thin omitted)
...
Cohesion: 0.09
Nodes (48): ConnectSlave_Request, ConnectSlave_Response, _ControlPlaneAPI_ConnectSlave_Handler(), _ControlPlaneAPI_EnablePlugin_Handler(), _ControlPlaneAPI_ListEnvironments_Handler(), _ControlPlaneAPI_ListNodes_Handler(), _ControlPlaneAPI_ListPlugins_Handler(), ClientConnInterface (+40 more)
...
Cohesion: 0.04
Nodes (55): Absent, BaseEnableHeadscaleServer, BaseEnablePluginRequest, ConnectSlave, ConnectSlaveRequest, ConnectSlaveResponse, ControlPlaneAPI, EnableHeadscaleServer (+47 more)
...
Cohesion: 0.07
Nodes (25): NodeBaseInfo, NodeStatus, Badge(), BadgeProps, IconButton(), IconButtonProps, SectionLabel(), SectionLabelProps (+17 more)
...
Cohesion: 0.09
Nodes (12): Pointer, NewContainer(), Mutex, NewPortManager(), APIClient, ContainerManager, Docker, New() (+4 more)

### Community 14 - "internal/storage (storage.go)"
Cohesion: 0.07
Nodes (14): Pointer, Storage, NewStorageContainer(), Querier, localStorage, Container, DeploymentsStorage, JobsStorage (+6 more)

### Community 15 - "internal/pipelines (fetch_by_api.go)"
Cohesion: 0.16
Nodes (25): CopyToVolumeTaskPayload, NewCopyToVolumeHandler(), copyToVolumeTask(), equalStrings(), VelezTask, patchClientAPIFields(), TestCopyFileJob_CopyToContainerError(), TestCopyFileJob_ExecError() (+17 more)
...
Cohesion: 0.09
Nodes (19): CreateServiceRequest, Credentials, ls, useCredentialsStore, InputProps, StyleProps, InputSearchProps, VolumeMappingProps (+11 more)

### Community 20 - "pkg/web (VervClosedNetworkPage.tsx)"
Cohesion: 0.08
Nodes (23): parseLogLevel(), ListNodesResponse, Level, StatCard(), StatCardProps, CodeBlock(), CodeBlockProps, tokenizeLine() (+15 more)

### Community 21 - "pkg/web (Router.tsx)"
Cohesion: 0.08
Nodes (27): Dialog(), DialogManager, useDialog, MainLayout(), NAV_TO_ROUTE, NavId, ROUTE_TO_NAV, TOOL_TO_ROUTE (+19 more)
...
Cohesion: 0.11
Nodes (16): ClusterStateManager, ClusterStateManagerContainer, Configurator, ServiceDiscovery, MakoshBeAPIClient, MatreshkaBeAPIClient, Storage, Context (+8 more)
...
Cohesion: 0.09
Nodes (18): ConfigFormat, Connection, Container, ContainerHardware, ContainerHealthcheck, ContainerSettings, Image, MatreshkaConfigSpec (+10 more)

### Community 27 - "internal/app (custom.go)"
Cohesion: 0.07
Nodes (29): ClusterClients, Impl, New(), App, App, Custom, Context, smerdsDropper() (+21 more)
...
Cohesion: 0.08
Nodes (9): MessageState, SizeCache, UnknownFields, ConnectSlave, ConnectSlave_Response, EnablePlugin, InitMaster_Response, ListEnvironments_Response (+1 more)
...
Cohesion: 0.11
Nodes (16): VervClosedNetworkClient, ConnectServiceToVcn, ConnectServiceToVpn(), pipeliner, ServiceDiscovery, Runner, GetClientKey(), Context (+8 more)

### Community 42 - "internal/pipelines (ConfigurationService)"
Cohesion: 0.10
Nodes (17): subscribeForConfigChangesStep, unsubscribeForConfigChangesStep, Context, SubscribeForConfigChanges(), Context, UnSubscribeForConfigChanges(), EnableVervServiceInMatreshka(), Context (+9 more)
...
Cohesion: 0.08
Nodes (24): LaunchSmerd, LaunchSmerdResult, CreateSmerd_Request, pipeliner, pipeliner, FetchConfig(), APIClient, Context (+16 more)
...
Cohesion: 0.07
Nodes (65): T, Time, NewAssembleConfigHandler(), TestAssembleConfigHandler_Action(), TestAssembleConfigHandler_NewContext(), TestClassifyImage(), TestCreateScratchContainerJob_ContainerCreateError(), TestCreateScratchContainerJob_Rollback_NoContainerId_NoOp() (+57 more)
...
Cohesion: 0.09
Nodes (8): AssembleConfig, InspectResponse, IsMatreshkaImage(), fromMatreshkaYamlToEvon(), fromYamlToEvon(), pipeliner, GetConfigNode_Response, Node
...
Cohesion: 0.06
Nodes (28): ContainerManager, FromContainerToRequest(), Context, Smerd, CheckUpgradeIsAvailable(), Context, Configurator, Container (+20 more)
...
Cohesion: 0.09
Nodes (20): New(), RollMigration(), NewTxManager(), Queries, newDeploymentsStorage(), Queries, newJobsStorage(), Queries (+12 more)
...
Cohesion: 0.09
Nodes (18): clusterClients, Client, Configurator, Context, ServiceDiscovery, Setup(), Context, SetupMasterPg() (+10 more)
...
Cohesion: 0.12
Nodes (4): SizeCache, CreateDeploy_Response, GetServiceResources, GetVervonomicon_Response
...
Cohesion: 0.12
Nodes (3): Message, GetServiceGraph, GetServiceMetrics_Request

### Community 92 - "internal/api (UnknownFields)"
Cohesion: 0.12
Nodes (4): UnknownFields, CreateDeploy, GetServiceEnvironments, RestartService_Response
...
Cohesion: 0.06
Nodes (31): Absent, AssembleConfig, AssembleConfigRequest, AssembleConfigResponse, BaseCreateSmerdRequest, BreakConnections, BreakConnectionsRequest, BreakConnectionsResponse (+23 more)
...
Cohesion: 0.07
Nodes (25): Code, fetchConfigStep, isCreateSmerd_Request_Config, AppConfig, ConfigMeta, errorResp, ConfigFormat, ConfigTypePrefix (+17 more)
...
Cohesion: 0.09
Nodes (23): Button(), ButtonProps, EnvCard(), EnvCardProps, ServiceEnvironment, ServiceResource, HeaderProps, IsStatefullModeEnabled() (+15 more)
...
Cohesion: 0.08
Nodes (37): ConnectServiceToVpnTaskPayload, Checkpoint(), Context, TestCheckpoint_FailFastWhenFailed(), TestCheckpoint_RunsAndPersistsContextOnSuccess(), TestCheckpoint_SkipsWhenDone(), connectServiceToVpnTask(), VelezTask (+29 more)
...
Cohesion: 0.40
Nodes (4): Context, ListVcnNamespaces_Request, ListVcnNamespaces_Response, Impl
...
Cohesion: 0.09
Nodes (16): AssembleConfigJobSuite, AssembleConfigSuite, addTestLabels(), AssertSmerds(), CreateSmerd_Request, Smerd, GetExpectedLabels(), GetServiceName() (+8 more)
...
Cohesion: 0.09
Nodes (18): GetVcnAuthKeyReq, IssueClientKey, ListVpnNamespaces, RegisterVcnNodeReq, VcnAuthKey, VcnNamespace, Context, Client (+10 more)
...
Cohesion: 0.08
Nodes (10): file_tasks_proto_init(), CreateSmerd_Request, MessageState, SizeCache, UnknownFields, CopyToVolumeTaskPayload, CreateSmerdTaskPayload, init() (+2 more)
...
Cohesion: 0.13
Nodes (9): VpnSuite, Context, runner[T], Test_Lifecycle(), Test_ControlPlane(), Test_HelloWorldCluster(), Context, Suite (+1 more)
...
Cohesion: 0.14
Nodes (17): getConfigFromContainerStep, copyToContainerStep, ConfigMount, FileMountPoint, APIClient, Context, ReadFromContainer(), WriteToContainer() (+9 more)
...
Cohesion: 0.33
Nodes (3): ServiceDiscovery, addMakoshRecordJob, connectServiceToVpnHandler
...
Cohesion: 0.12
Nodes (17): Port, Volume, ActionButton(), ActionButtonProps, VolumesWidgetProps, ValuesPair(), VolumeMappingProps, Bind (+9 more)
...
Cohesion: 0.18
Nodes (15): toProto(), SmerdPage(), GetInitReq(), InitReq, keyPath(), pathPrefixPath(), StoreApiKey(), StorePathPrefix() (+7 more)

### Community 230 - "internal/api (GetServiceMetrics_Request)"
Cohesion: 0.12
Nodes (3): file_service_api_proto_rawDescGZIP(), CreateService, RestartService_Request
...
Cohesion: 0.10
Nodes (7): file_tasks_proto_rawDescGZIP(), EnumDescriptor, EnumNumber, EnumType, Timestamp, TaskStatus, TaskStatus_Status
...
Cohesion: 0.18
Nodes (8): CreateRequest, TailScaleContainerSidecar(), assembleConfigHandler, Job, NamedJob, RollbackableJob, TaskContext, testHandler
...
Cohesion: 0.29
Nodes (4): Queries, Tx, VelezJob, fakeJobsStorage
...
Cohesion: 0.21
Nodes (6): Context, Client, Context, CreateVcnNamespace_Request, CreateVcnNamespace_Response, Impl
...
### Community 313 - "internal/clients (.GetNamespace())"
Cohesion: 0.40
...
Cohesion: 0.10
Nodes (17): Checkbox(), CheckboxProps, InfoMark(), InfoMarkProps, KeyValueProps, PlainMapProps, Search(), SearchParam (+9 more)
...
Cohesion: 0.12
Nodes (4): MessageState, CreateService_Response, GetService, StopService
...
Cohesion: 0.12
Nodes (5): file_service_api_proto_init(), init(), GetService_Response_VervService, GetVervonomicon, ListServices
...
- **Why does `T` connect `tests/e2e (T)` to `tests/e2e (suite_hello_world_cluster_test.go)`, `.enrichServiceWithSmerdData`, `internal/pipelines (Step)`, `internal/api (PatchConfig_Request)`, `tests/e2e (NewEnvironment())`, `GetService`, `internal/clients (PortManager)`, `internal/pipelines (fetch_by_api.go)`, `internal/transport (Pipeliner)`, `pkg/web (ControlPlanePage.tsx)`, `pkg/web (fetch.pb.ts)`, `TestEnvironment`, `internal/api (ConfigBase)`?**
  _High betweenness centrality (0.126) - this node is a cross-community bridge._
- **Why does `file_velez_common_proto_init()` connect `internal/api (velez_common.pb.go)` to `internal/api (velez_api.pb.go)`, `internal/api (control_plane_api.pb.go)`, `StopService_Response`, `pkg/web (package.json)`?**
  _High betweenness centrality (0.124) - this node is a cross-community bridge._
- **Why does `NodeClients` connect `internal/clients (NodeClients)` to `ListEnvironments_Response`, `pkg/web (DeployWidget.tsx)`, `internal/clients (PortManager)`, `internal/pipelines (fetch_by_api.go)`, `internal/transport (Pipeliner)`, `pkg/web (ControlPlanePage.tsx)`, `internal/storage (deployments)`, `internal/app (custom.go)`, `internal/config (launch.go)`, `internal/pipelines (create_and_inspect.go)`, `internal/pipelines (ConnectServiceToVpn())`, `internal/pipelines (LaunchSmerd)`, `internal/pipelines (do_copy_to_volume.go)`, `internal/pipelines (.UpgradeSmerd())`, `FromPorts`, `tests/e2e (T)`, `Paging`, `internal/pipelines (fetch_from_container.go)`, `Version_Response`, `renameContainerStep`, `internal/domain (node.go)`, `internal/api (CreateDeploy)`?**
...
- **Should `internal/api (matreshka_api.pb.go)` be split into smaller, more focused modules?**
  _Cohesion score 0.03315018315018315 - nodes in this community are weakly interconnected._