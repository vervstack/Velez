# Graph Report - Velez  (2026-08-02)

## Corpus Check

- 606 files · ~297,958 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary

- 6901 nodes · 11937 edges · 702 communities (366 shown, 336 thin omitted)
- Extraction: 94% EXTRACTED · 6% INFERRED · 0% AMBIGUOUS · INFERRED: 732 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness

- Built from commit: `61cd6a5d`
...
- **Velez Configuration Environment Variable Schema** —
  config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_configyaml,
...
## Communities (702 total, 336 thin omitted)
...
Cohesion: 0.04
Nodes (21): file_matreshka_api_proto_init(), file_matreshka_api_proto_rawDescGZIP(), Message, MessageState, SizeCache,
UnknownFields, init(), CreateConfig (+13 more)
...
Cohesion: 0.08
Nodes (31): connectToNetwork(), createNetworkIfMissing(), disconnectFromNetworks(), fromContainerNetwork(),
ConfigTypePrefix, ContainerState, Context, CreateSmerd_Request (+23 more)

### Community 6 - "pkg/web (ServiceCard.tsx)"

Cohesion: 0.09
Nodes (29): AppCard(), AppCardProps, EnvChip(), EnvChipProps, FreezeChip(), IncidentChip(), MiniBar(), MiniBarProps (+21
more)
...
Cohesion: 0.12
Nodes (4): MessageState, CreateService, GetVervonomicon, RemoveService

### Community 9 - "pkg/web (ServiceInfoPage.tsx)"

Cohesion: 0.07
Nodes (37): EnvCard(), EnvCardProps, ServiceEnvironment, ServiceGraphNode, ServiceResource, VervonomiconDocs, LIST_REQ,
useGetServiceAboutQuery() (+29 more)

### Community 12 - "pkg/web (DeployWidget.tsx)"

Cohesion: 0.16
Nodes (17): classifyImage(), fromMatreshkaYamlToEvon(), fromYamlToEvon(), APIClient, ConfigFormat, Context, Docker,
isPostgresByImageTags() (+9 more)

### Community 13 - "internal/clients (PortManager)"

Cohesion: 0.07
Nodes (22): ConfigFormat, Connection, Container, ContainerHardware, ContainerHealthcheck, ContainerSettings, FileConfig,
Image (+14 more)

### Community 14 - "internal/storage (storage.go)"

Cohesion: 0.05
Nodes (21): ClusterStateManager, Storage, Pointer, NewContainer(), Pointer, Storage, Querier, fakeClusterStorage (+13
more)

### Community 15 - "internal/pipelines (fetch_by_api.go)"

Cohesion: 0.07
Nodes (29): parseLogLevel(), DeploymentStatus, Badge(), BadgeProps, Level, StatCard(), StatCardProps, CodeBlock() (+21
more)

### Community 16 - "internal/transport (Pipeliner)"

Cohesion: 0.20
Nodes (11): Context, Docker, Volume, writeFileToContainer(), copyAPI, copyFileJob, copyToVolumeRequestAccessor,
createLoaderContainerJob (+3 more)

### Community 17 - "internal/transport (grpcServer)"

Cohesion: 0.06
Nodes (31): CMux, Cors, FS, Group, HandlerFunc, Context, Listener, ServeMux (+23 more)
...
Cohesion: 0.07
Nodes (57): NewAssembleConfigHandler(), TestAssembleConfigHandler_Action(), TestAssembleConfigHandler_NewContext(),
TestClassifyImage(), TestCreateScratchContainerJob_ContainerCreateError(),
TestCreateScratchContainerJob_Rollback_NoContainerId_NoOp(),
TestCreateScratchContainerJob_Rollback_NotFoundIsSwallowed(),
TestCreateScratchContainerJob_Rollback_RemoveErrorPropagates() (+49 more)

### Community 21 - "pkg/web (Router.tsx)"

Cohesion: 0.04
Nodes (54): ListNodesResponse, NodeBaseInfo, NodeStatus, MainLayout(), NAV_TO_ROUTE, NavId, ROUTE_TO_NAV,
TOOL_TO_ROUTE (+46 more)

### Community 22 - "internal/api (Context)"

Cohesion: 0.07
Nodes (23): ClientConnInterface, Context, ServiceRegistrar, UnaryServerInterceptor, Version_Request, Version_Response, _
MatreshkaApi_CreateConfig_Handler(), _MatreshkaApi_DeleteConfig_Handler() (+15 more)

### Community 23 - "pkg/web (service_api.pb.ts)"

Cohesion: 0.03
Nodes (62): AboutService, Absent, BaseCreateDeployRequest, BaseGetServiceResponse, BoundResource, CreateDeploy,
CreateDeployRequest, CreateDeployRequestUpgrade (+54 more)

### Community 24 - "internal/clients (cluster.go)"

Cohesion: 0.05
Nodes (41): CreateSmerdRequest, Port, Volume, ActionButton(), ActionButtonProps, Checkbox(), CheckboxProps, InfoMark() (
+33 more)

### Community 25 - "internal/storage (deployments)"

Cohesion: 0.12
Nodes (13): Context, GetServiceEnvironments_Request, GetServiceEnvironments_Response, Impl, Context, Handler, Impl,
ServiceRegistrar (+5 more)
...
Cohesion: 0.08
Nodes (9): MessageState, SizeCache, UnknownFields, ConnectSlave, ConnectSlave_Response, InitMaster_Request,
ListEnvironments_Request, ListPlugins (+1 more)
...
Cohesion: 0.10
Nodes (27): NewConnectServiceToVpnHandler(), patchStartAPIField(), TestAddMakoshRecordJob_Success(),
TestAddMakoshRecordJob_UpsertError(), TestConnectServiceToVpnHandler_Action(),
TestConnectServiceToVpnHandler_BuildJobs_NamesAndOrder(), TestConnectServiceToVpnHandler_NewContext(),
TestCreateSidecarContainerJob_ContainerCreateError() (+19 more)
...
Cohesion: 0.13
Nodes (16): ListServicesReq, Paging, Connection, Context, DropSmerd_Request, DropSmerd_Response, ListSmerds_Request,
ListSmerds_Response (+8 more)

### Community 34 - "internal/transport (deploy_list.go)"

Cohesion: 0.12
Nodes (13): FromPaging(), Paging, Context, Impl, ListNodes_Request, ListNodes_Response, Context, DeploymentStatus (+5
more)
...
Cohesion: 0.11
Nodes (11): CreateDeploymentParams, CreateSpecificationParams, UpdateDeploymentStatusParams, Queries, Tx, Context,
Queries, NullInt64 (+3 more)

### Community 38 - "internal/api (VervAppService)"

Cohesion: 0.07
Nodes (8): EnumDescriptor, EnumNumber, EnumType, DeploymentStatus, GetService_Response_VervService,
GetVervonomicon_Response, NodeType, VervAppService
...
Cohesion: 0.10
Nodes (14): ApiVersion_Request, ApiVersion_Response, disabledConfigurator, disabledServiceDiscovery,
BidiStreamingClient, Context, ListEndpoints_Request, ListEndpoints_Response (+6 more)

### Community 41 - "internal/pipelines (ConnectServiceToVpn())"

Cohesion: 0.07
Nodes (41): T, TestCreateSmerdRequest_NilVervAndPlainStayNil(), TestCreateSmerdRequest_PlainSurvivesRoundTrip(),
TestCreateSmerdRequest_SurvivesRoundTripEmbeddedInTaskPayload(),
TestCreateSmerdRequest_VervAndPlainBothSurviveRoundTrip(), TestCreateSmerdRequest_VervSurvivesRoundTrip(),
TestUpgradeSmerdRequest_SurvivesRoundTripEmbeddedInTaskPayload(), Time (+33 more)

### Community 42 - "internal/pipelines (ConfigurationService)"

Cohesion: 0.06
Nodes (36): AssembleConfigTaskPayload, ConnectServiceToVpnTaskPayload, CopyToVolumeTaskPayload,
CreateServiceTaskPayload, CreateSmerdTaskPayload, DropSmerdTaskPayload, EnableStatefullTaskPayload, TasksApi (+28 more)
...
Cohesion: 0.10
Nodes (7): Container_Hardware, Container_Healthcheck, Container_Settings, FileConfig, MatreshkaConfigSpec,
RestartPolicy, CreateSmerd_Request

### Community 45 - "internal/pipelines (LaunchSmerd)"

Cohesion: 0.12
Nodes (16): Context, CreateRequest, Docker, ServiceDiscovery, addMakoshRecordJob, clientKeyAccessor,
connectServiceToVpnHandler, connectServiceToVpnRequestAccessor (+8 more)
...
Cohesion: 0.05
Nodes (39): b64, b64Decode(), b64Encode(), fetchStreamingRequest(), FlattenedRequestPayload, flattenRequestPayload(),
getNewLineDelimitedJSONDecodingStream(), getNotifyEntityArrivalSink() (+31 more)

### Community 50 - "internal/clients (NodeClients)"

Cohesion: 0.04
Nodes (47): AssembleConfig, AssembleConfigRequest, AssembleConfigResponse, BreakConnections, BreakConnectionsRequest,
BreakConnectionsResponse, CreateSmerd, DropSmerd (+39 more)

### Community 51 - "internal/pipelines (.UpgradeSmerd())"

Cohesion: 0.10
Nodes (21): CreateServiceRequest, ConnectionHealth, ConnectionHealthStatus, useConnectionHealth(), Credentials, ls,
useCredentialsStore, InitReq (+13 more)

### Community 52 - "internal/api (SubscribeOnChanges_Response)"

Cohesion: 0.09
Nodes (6): BidiStreamingServer, BidiStreamingClient, ServerStream, _MatreshkaApi_SubscribeOnChanges_Handler(),
SubscribeOnChanges_Request, SubscribeOnChanges_Response
...
Cohesion: 0.09
Nodes (23): devDependencies, eslint, eslint-import-resolver-typescript, @eslint/js, eslint-plugin-import-x,
eslint-plugin-react, eslint-plugin-react-hooks, eslint-plugin-react-refresh (+15 more)

### Community 58 - "internal/storage (ListServicesReq)"

Cohesion: 0.12
Nodes (16): BoundResource, Context, countTotal(), fromStorageToDomainService(), Context, Querier, SelectBuilder,
Service (+8 more)
...
Cohesion: 0.11
Nodes (12): firstNotEmptyKey(), Once, NewSecurityManager(), readStateFromPath(), writeKey(), fakeStateManager,
ClusterState, Headscale (+4 more)

### Community 63 - "pkg/web (fetch.pb.ts)"

Cohesion: 0.05
Nodes (28): ConnectServiceToVcn, GetVcnAuthKeyReq, IssueClientKey, ListVpnNamespaces, RegisterVcnNodeReq,
SetupHeadscaleRequest, SetupHeadscaleResponse, VcnAuthKey (+20 more)

### Community 64 - "pkg/web (ServiceService)"

Cohesion: 0.31
Nodes (8): DeploymentInfo, DeploymentHistoryProps, DeployRow(), DeployRowProps, formatTimestamp(), getStatusClass(),
parseImageTag(), TODO: replace with git commit hash when GetServiceGraph adds git field

### Community 65 - "pkg/web (HomePage.tsx)"

Cohesion: 0.20
Nodes (13): TaskStatus_JobStatus, VelezJobStatus, VelezTask, VelezTaskStatus, jobStatusesToProto(), jobStatusToProto(),
New(), taskStatusToProto() (+5 more)
...
Cohesion: 0.17
Nodes (12): CheckUpgradeIsAvailable(), Context, Step, TestCreateNewDeploy_GetByNameError(),
TestUpgradeDeploy_GetByNameError(), Docker, Storage, VervService (+4 more)

### Community 70 - "pkg/web (verv_closed_network.pb.ts)"

Cohesion: 0.08
Nodes (57): Code, EnableStatefullTaskPayload, RespError, PgName(), proto(),
TestStartSidecarContainerJob_Rollback_StopsContainer(), NewEnableStatefullHandler(), enableStatefullTask() (+49 more)

### Community 71 - "internal/storage (models.go)"

Cohesion: 0.10
Nodes (24): NullVelezDeploymentStatus, NullVelezJobStatus, NullVelezTaskStatus, VelezDeployment,
VelezDeploymentSpecification, VelezDeploymentStatus, VelezJob, VelezJobStatus (+16 more)

### Community 72 - "internal/domain (service.go)"

Cohesion: 0.09
Nodes (19): Context, Duration, VelezTask, Context, Handler, ServiceRegistrar, Impl, New() (+11 more)

### Community 73 - "tests/e2e (NewEnvironment())"

Cohesion: 0.05
Nodes (46): ControlPlaneSuite, EnableStatefullSuite, LifecycleSuite, StateOpt, TestEnvironment, TestEnvOpt,
UpgradeSmerdSuite, VpnSuite (+38 more)
...
Cohesion: 0.09
Nodes (16): AppConfig, ConfigMeta, ConfigMount, ConfigurationPatch, ConfigFormat, ConfigTypePrefix, Configurator,
Context (+8 more)

### Community 82 - "internal/storage (service_dependencies.go)"

Cohesion: 0.08
Nodes (22): Custom, ClusterClients, Impl, App, Context, Listener, New(), App (+14 more)
...
Cohesion: 0.10
Nodes (22): RollMigration(), getExposedPgPort(), Container, Context, InspectResponse, containerInspectAPI,
createPgContainerJob, createPgUserJob (+14 more)
...
Cohesion: 0.07
Nodes (28): LaunchSmerd, LaunchSmerdResult, CreateSmerd_Request, pipeliner, pipeliner, FetchConfig(), APIClient,
Context (+20 more)

### Community 98 - "internal/service (configurator.go)"

Cohesion: 0.12
Nodes (3): isPatch_Patch, Patch, PatchConfig_Request

### Community 99 - "internal/api (Message)"

Cohesion: 0.18
Nodes (3): MessageState, BreakConnections, GetHardware_Request
...
Cohesion: 0.05
Nodes (29): CopyToContainerOptions, CreateOptions, Context, APIClient, Context, CreateResponse, EndpointSettings,
ExecOptions (+21 more)

### Community 104 - "pkg/web (control_plane.ts)"

Cohesion: 0.15
Nodes (12): CopyToVolumeRequest, pipeliner, NewCopyToVolumeRunner(), Runner, DropContainerStep(), Context, Docker,
Exec() (+4 more)
...
Cohesion: 0.06
Nodes (17): storeConfigStep, file_matreshka_common_proto_init(), file_matreshka_common_proto_rawDescGZIP(),
EnumDescriptor, EnumNumber, EnumType, init(), Configurator (+9 more)
...
Cohesion: 0.18
Nodes (5): file_service_api_proto_init(), CreateDeploy_Request_Upgrade, init(), CreateDeploy_Request,
isCreateDeploy_Request_Specification

### Community 116 - "internal/api (Message)"

Cohesion: 0.04
Nodes (71): Absent, BaseEnableHeadscaleServer, BaseEnablePluginRequest, ConnectSlave, ConnectSlaveRequest,
ConnectSlaveResponse, ControlPlaneAPI, EnableHeadscaleServer (+63 more)
...
Cohesion: 0.23
Nodes (8): Context, CreateSmerd_Request, Handler, ServerStreamingServer, ServiceRegistrar, TaskStatus,
WatchTask_Request, Impl
...
Cohesion: 0.18
Nodes (12): ConnectToNetworkRequest, ConnectToNetwork(), CreateNetwork(), DisconnectFromNetworks(), APIClient, Context,
EndpointSettings, APIClient (+4 more)
...
Cohesion: 0.07
Nodes (8): MessageState, SizeCache, UnknownFields, Connection, Container, FileConfig, PlainConfigSpec, RestartPolicy
...
Cohesion: 0.23
Nodes (11): containerStateToDeploymentStatus(), containerStateToString(), countRunningServices(), Context,
DeploymentStatus, Docker, Service, ServiceBaseInfo (+3 more)

### Community 136 - "pkg/web (ResourcesSection.tsx)"

Cohesion: 0.06
Nodes (19): Pointer, NewContainer(), NewPortManager(), Container, Docker, APIClient, ContainerState, Context (+11 more)
...
Cohesion: 0.05
Nodes (11): Message, MessageState, SizeCache, Timestamp, UnknownFields, ConfigBase, ConfigInfo, GetConfig_Response (+3
more)
...
Cohesion: 0.15
Nodes (13): dependencies, classnames, framer-motion, @microlink/react-json-view, react, react-dom, react-router-dom,
react-tooltip (+5 more)
...
Cohesion: 0.06
Nodes (59): ConnectServiceToVpnTaskPayload, CopyToVolumeTaskPayload, App, Checkpoint(), Context,
TestCheckpoint_FailFastWhenFailed(), TestCheckpoint_RunsAndPersistsContextOnSuccess(), TestCheckpoint_SkipsWhenDone() (
+51 more)

### Community 156 - "internal/transport (VcnNamespace)"

Cohesion: 0.08
Nodes (22): New(), NewTxManager(), Queries, newDeploymentsStorage(), Queries, newJobsStorage(), Querier,
newPluginsStorage() (+14 more)

### Community 158 - "internal/api (file_control_plane_api_proto_rawDescGZIP())"

Cohesion: 0.20
Nodes (13): extract_message(), main(), WithExposedPort(), WithInstanceName(), WithPassword(), WithPort(),
basicPostgresConstructor(), CreateRequest (+5 more)

### Community 159 - "tests/e2e (suite_hello_world_cluster_test.go)"

Cohesion: 0.08
Nodes (14): AssembleConfigJobSuite, AssembleConfigSuite, Context, runner[T], Context, Suite, Test_AssembleConfigJob(),
Context (+6 more)
...
Cohesion: 0.12
Nodes (20): Connect(), ConnectToContainer(), getAPIAddress(), Context, Docker, Client, Container, Context (+12 more)
...
Cohesion: 0.16
Nodes (10): VelezJob, Context, Queries, NullString, VelezJob, VelezJobStatus, fakeJobsStorage, CreateRunningJobParams (
+2 more)

### Community 171 - "internal/api (matreshka_common.pb.go)"

Cohesion: 0.13
Nodes (15): AboutService, CreateDeployReq, CreateServiceReq, RemoveServiceReq, Service, ServiceBaseInfo, ServiceList,
UpgradeDeployReq (+7 more)
...
Cohesion: 0.16
Nodes (13): GetSpecificationByIdRow, Deployment, DeploymentList, DeploymentSpecification, ListDeploymentsReq, Paging,
Time, VelezDeploymentStatus (+5 more)

### Community 177 - "internal/api (Container_Hardware)"

Cohesion: 0.10
Nodes (22): APIClient, Context, CreateSmerd_Request, Docker, FileConfig, MatreshkaConfigSpec, containerIDAccessor,
copyToContainerJob (+14 more)

### Community 178 - "internal/api (Container_Healthcheck)"

Cohesion: 0.10
Nodes (17): PluginBaseInfo, DeploymentStatus, VervPlugin_State, Context, Docker, newPluginsStorage(), Context,
NullInt64 (+9 more)

### Community 180 - "internal/api (Image)"

Cohesion: 0.09
Nodes (23): fetchConfigStep, getConfigFromContainerStep, copyToContainerStep, FileMountPoint, APIClient, Context,
ReadFromContainer(), WriteToContainer() (+15 more)
...
Cohesion: 0.11
Nodes (4): SizeCache, CreateService_Response, RemoveService_Request, RestartService
...
Cohesion: 0.29
Nodes (7): VelezJobStatus, Context, VelezTask, JobStatus, enqueueCall, fakeJobsEngine, watchCall
...
Cohesion: 0.11
Nodes (16): NodeType, ServiceDependency, ServiceEnvironment, ServiceGraph, Time, Context, VervService, containerName() (
+8 more)
...
Cohesion: 0.05
Nodes (34): ClusterStateManagerContainer, Configurator, ServiceDiscovery, VervClosedNetworkClient, clusterClients,
MakoshBeAPIClient, MatreshkaBeAPIClient, Client (+26 more)
...
Cohesion: 0.18
Nodes (3): SizeCache, BreakConnections_Response, UpgradeSmerd
...
Cohesion: 0.27
Nodes (11): NodeBaseInfo, NodeStatusFromLastOnline(), Test_NodeStatusFromLastOnline_DisabledNodeIsOffline(),
Test_NodeStatusFromLastOnline_FreshHeartbeatIsOnline(), Test_NodeStatusFromLastOnline_PastOfflineThresholdIsOffline(),
Test_NodeStatusFromLastOnline_StaleUnderOfflineThresholdIsDegraded(),
Test_ToBasicNodeInfo_PassesThroughRegionUnchanged(), Test_ToBasicNodeInfo_PassesThroughUsageFieldsUnchanged() (+3 more)

### Community 271 - "internal/clients (hardware_manager.go)"

Cohesion: 0.20
Nodes (10): Manager, Context, GetHardware_Response, Mutex, Time, New(), TestManager_GetHardware_CachesWithinTTL(),
TestManager_GetHardware_IsRunningInContainer() (+2 more)
...
Cohesion: 0.18
Nodes (3): UnknownFields, AssembleConfig, CreateSmerd

### Community 277 - "VelezAPI"

Cohesion: 0.15
Nodes (14): Context, CreateSmerd_Request, ServerStream, ServerStreamingServer, ServiceRegistrar, TaskStatus,
WatchTask_Request, RegisterTasksApiServer() (+6 more)
...
Cohesion: 0.23
Nodes (7): subscribeForConfigChangesStep, unsubscribeForConfigChangesStep, Context, SubscribeForConfigChanges(),
Context, UnSubscribeForConfigChanges(), ConfigurationService
...
Cohesion: 0.14
Nodes (12): Approach, Exit criteria, M1 — Core Platform, Task groups, 1.1 Services list (HomePage), 1.2 Service detail (
ServiceInfoPage), 1.3 Smerds list (smerd containers), 1.4 Smerd detail (SmerdPage) (+4 more)
...
Cohesion: 0.22
Nodes (8): 4.1 Settings widget (already partially exists), 4.2 Connection health indicator, 4.3 Settings validation, 4.4
Environment variable display (informational), Acceptance criteria, Goal, T4 — Settings Panel, Tasks
...
Cohesion: 0.18
Nodes (12): ServiceBaseInfo, TestToServiceBaseInfoList(), TestToServiceBaseInfoWithEmptyFields(),
TestToServiceBaseInfoWithEnrichedFields(), toServiceBaseInfo(), toServiceBaseInfoList(), fromListServiceRequest(),
Context (+4 more)
...
Cohesion: 0.09
Nodes (27): AliveKeeper, AppInfo, Config, EnvironmentConfig, ServersConfig, SharedInstance, sharedInstanceCtxKey,
getKeyFromMatreshkaContainerEnv() (+19 more)
...
Cohesion: 0.07
Nodes (17): Context, Context, Docker, assembleConfigHandler, checkpointedJob, copyToVolumeHandler, createServiceHandler,
createSmerdHandler (+9 more)

### Community 615 - "InitMaster"

Cohesion: 0.12
Nodes (3): Message, EnablePlugin, ListNodes
...
Cohesion: 0.12
Nodes (4): UnknownFields, CreateDeploy_Response, GetService, GetServiceResources
...
- **1062 isolated node(s):** `status.sh script`, `go.vervstack.ru/Velez`, `UnsafeMatreshkaApiServer`,
  `UnsafeControlPlaneAPIServer`, `UnsafeServiceApiServer` (+1057 more)
...
- **Why does `T` connect `internal/pipelines (ConnectServiceToVpn())`
  to `internal/service (list_test.go)`, `pkg/web (HomePage.tsx)`, `pkg/web (service.ts)`,
  `pkg/web (verv_closed_network.pb.ts)`, `pkg/web (ResourcesSection.tsx)`, `tests/e2e (NewEnvironment())`, `RespError`,
  `internal/storage (node.go)`, `ListEnvironments_Response`, `internal/clients (hardware_manager.go)`,
  `.enrichServiceWithSmerdData`, `internal/transport (grpcServer)`, `internal/pipelines (do_copy_to_volume.go)`,
  `pkg/web (index.ts)`, `initKey`, `pkg/web (ControlPlanePage.tsx)`, `internal/api (UnknownFields)`,
  `tests/e2e (suite_hello_world_cluster_test.go)`?**
  _High betweenness centrality (0.207) - this node is a cross-community bridge._
- **Why does `file_velez_common_proto_init()` connect `internal/api (SearchImageItem)`
  to `internal/api (velez_api.pb.go)`, `internal/api (velez_common.pb.go)`, `internal/api (control_plane_api.pb.go)`,
  `internal/api (UnknownFields)`?**
  _High betweenness centrality (0.164) - this node is a cross-community bridge._
- **Why does `b64Decode()` connect `internal/pipelines (do_copy_to_volume.go)`
  to `internal/pipelines (ConnectServiceToVpn())`?**
  _High betweenness centrality (0.142) - this node is a cross-community bridge._
- **Are the 60 inferred relationships involving `newFakeDocker()` (e.g.
