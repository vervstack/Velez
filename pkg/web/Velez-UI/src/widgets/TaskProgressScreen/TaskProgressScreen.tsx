...
import ProgressStepChip from "@/widgets/TaskProgressScreen/components/ProgressStepChip/ProgressStepChip.tsx"
import cls from "@/widgets/TaskProgressScreen/TaskProgressScreen.module.css"
import {WatchTaskStream} from "@/processes/api/tasks.ts"

// WatchableTaskStart is the entity_id/action pair TasksApi.WatchTask needs -
// any job-engine RPC that enqueues a task and returns immediately (
// EnablePluginResponse, CreateRegistryInstanceResponse, ...) satisfies this
// shape structurally.
