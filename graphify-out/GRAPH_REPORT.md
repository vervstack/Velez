...
## Corpus Check
- 575 files · ~272,238 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 6632 nodes · 11097 edges · 755 communities (372 shown, 383 thin omitted)
- Extraction: 95% EXTRACTED · 5% INFERRED · 0% AMBIGUOUS · INFERRED: 579 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `d6240e33`
...
- internal/pipelines (do_create_service.go)
...
- **Velez Configuration Environment Variable Schema** — config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_configyaml, config_configtemplate, docs_configuration [INFERRED 0.90]
...
## Communities (755 total, 383 thin omitted)
...
Cohesion: 0.09
Nodes (29): connectToNetwork(), disconnectFromNetworks(), fromContainerNetwork(), ConfigTypePrefix, ContainerState, Context, Docker, EndpointSettings (+21 more)
...
Cohesion: 0.08
Nodes (30): ControlPlaneAPI, EnableStatefullCluster, ListEnvironmentsResponse, VervPlugin, VervPluginState, VervPluginType, Dialog(), DialogManager (+22 more)

### Community 9 - "pkg/web (ServiceInfoPage.tsx)"
Cohesion: 0.06
Nodes (49): Toast, Toaster, useToaster, SkeletonDeploymentHistory(), LoaderWithErrorProps, LoaderWrapper(), ServiceGraphNode, DeployMenu() (+41 more)
...
Cohesion: 0.11
Nodes (32): EnableStatefullTaskPayload, proto(), TestStartSidecarContainerJob_ContainerStartError(), TestStartSidecarContainerJob_NoContainerId_Error(), TestStartSidecarContainerJob_Rollback_StopsContainer(), TestStartSidecarContainerJob_Success(), NewEnableStatefullHandler(), enableStatefullTask() (+24 more)
...
Cohesion: 0.08
Nodes (12): Pointer, NewContainer(), NewPortManager(), Container, Docker, fakeNodeClients, Docker, HardwareManager (+4 more)

### Community 14 - "internal/storage (storage.go)"
Cohesion: 0.09
Nodes (7): Pointer, Storage, fakeClusterStorage, Container, NodesStorage, PluginsStorage, ServiceResourcesStorage

### Community 15 - "internal/pipelines (fetch_by_api.go)"
Cohesion: 0.06
Nodes (26): Configurator, ServiceDiscovery, VervClosedNetworkClient, clusterClients, MakoshBeAPIClient, MatreshkaBeAPIClient, Client, Configurator (+18 more)
...
Cohesion: 0.05
Nodes (42): parseLogLevel(), ListNodesResponse, NodeBaseInfo, NodeStatus, Badge(), BadgeProps, IconButton(), IconButtonProps (+34 more)

### Community 21 - "pkg/web (Router.tsx)"
Cohesion: 0.11
Nodes (21): EnvCard(), EnvCardProps, ServiceEnvironment, ControlPlanePage(), IsStatefullModeEnabled(), ListEnvironmentsQuery(), ListNodesQuery(), ListPluginsQuery() (+13 more)
...
Cohesion: 0.03
Nodes (63): AboutService, Absent, BaseCreateDeployRequest, BaseGetServiceResponse, BoundResource, CreateDeploy, CreateDeployRequest, CreateDeployRequestUpgrade (+55 more)

### Community 24 - "internal/clients (cluster.go)"
Cohesion: 0.15
Nodes (9): ClusterStateManagerContainer, Context, Storage, NewPgStateManager(), Context, SetupPgState(), Container, enableStatefullHandler (+1 more)
...
Cohesion: 0.09
Nodes (23): ListServicesReq, ServiceList, Paging, Context, ServiceBaseInfo, VervService, mapSmerdStatus(), Connection (+15 more)
...
Cohesion: 0.11
Nodes (17): AppInfo, Config, EnvironmentConfig, ServersConfig, MakoshBeAPIClient, NewClient(), NewServiceDiscovery(), NewSecurityManager() (+9 more)
...
Cohesion: 0.16
Nodes (19): newFakeContainerService(), NewUpgradeSmerdHandler(), realPortManager(), strPtr(), TestCaptureOldContainerJob_InspectError(), TestCaptureOldContainerJob_Success(), TestCheckSelfUpgradeJob_NotInsideContainer_NoOp(), TestFetchUpgradeConfigJob_RestoresNameAndMergesEnv() (+11 more)
...
Cohesion: 0.09
Nodes (8): Container_Hardware, Container_Healthcheck, Container_Settings, MatreshkaConfigSpec, RestartPolicy, CreateSmerd_Request, isCreateSmerd_Request_Config, CreateSmerd_Request_Verv
...
Cohesion: 0.08
Nodes (19): useCredentialsStore, Button(), ButtonProps, ServiceResource, NewServicePage(), HeaderProps, useGetServiceResourcesQuery(), ObservabilityToolsProps (+11 more)
...
Cohesion: 0.10
Nodes (24): Connect(), ConnectToContainer(), getApiAddress(), Context, Docker, Client, Container, Docker (+16 more)
...
Cohesion: 0.06
Nodes (76): T, TestCreateSmerdRequest_NilConfigStaysNil(), TestCreateSmerdRequest_PlainConfigSurvivesRoundTrip(), TestCreateSmerdRequest_SurvivesRoundTripEmbeddedInTaskPayload(), TestCreateSmerdRequest_VervConfigSurvivesRoundTrip(), Time, NewAssembleConfigHandler(), TestAssembleConfigHandler_Action() (+68 more)
...
Cohesion: 0.06
Nodes (34): ClusterClients, Context, Duration, VelezTask, NewEngine(), Pipeliner, NewPipeliner(), Context (+26 more)
...
Cohesion: 0.08
Nodes (24): Closable, New(), Queries, newDeploymentsStorage(), Queries, newJobsStorage(), Context, NodeBaseInfo (+16 more)
...
Cohesion: 0.13
Nodes (15): AboutService, CreateDeployReq, CreateServiceReq, GetServiceReq, Service, ServiceBaseInfo, UpgradeDeployReq, DeploymentStatus (+7 more)

### Community 73 - "tests/e2e (NewEnvironment())"
Cohesion: 0.06
Nodes (41): ControlPlaneSuite, LifecycleSuite, StateOpt, TestEnvironment, TestEnvOpt, VpnSuite, addTestLabels(), AssertSmerds() (+33 more)
...
Cohesion: 0.20
Nodes (7): AppConfig, ConfigMeta, ConfigFormat, ConfigTypePrefix, Configurator, Context, fakeConfigurationService
...
Cohesion: 0.16
Nodes (16): RollMigration(), getExposedPgPort(), Context, InspectResponse, containerInspectAPI, createPgContainerJob, createPgUserJob, createSchemaAndMigrateJob (+8 more)
...
Cohesion: 0.12
Nodes (10): InputProps, StyleProps, KeyValueProps, PlainMapProps, InputSearchProps, PortMapping(), PortMappingProps, VolumeMappingProps (+2 more)

### Community 92 - "internal/api (UnknownFields)"
Cohesion: 0.12
Nodes (4): UnknownFields, CreateService, GetServiceEnvironments, RestartService_Response
...
Cohesion: 0.07
Nodes (23): CopyToContainerOptions, CreateOptions, patchStartAPIField(), APIClient, Context, CreateResponse, EndpointSettings, ExecOptions (+15 more)

### Community 104 - "pkg/web (control_plane.ts)"
Cohesion: 0.08
Nodes (21): CopyToVolumeRequest, pipeliner, NewCopyToVolumeRunner(), pipeliner, Runner, DropContainerStep(), Context, Docker (+13 more)
...
Cohesion: 0.11
Nodes (18): MainLayout(), NAV_TO_ROUTE, NavId, ROUTE_TO_NAV, TOOL_TO_ROUTE, ToolId, router, Arguments (+10 more)
...
Cohesion: 0.12
Nodes (3): file_service_api_proto_rawDescGZIP(), GetServiceGraph, GetServiceMetrics_Request
...
Cohesion: 0.12
Nodes (14): HealthConfig, FromCommand(), FromHealthcheck(), Container_Healthcheck, FromRestart(), RestartPolicy, Create(), APIClient (+6 more)
...
Cohesion: 0.15
Nodes (10): runner, GetLoginServerUrl(), Context, ValidateServiceName(), Context, SingleFunc(), getLoginServerUrlStep, RollbackableStep (+2 more)
...
Cohesion: 0.09
Nodes (42): CopyToVolumeTaskPayload, Checkpoint(), Context, TestCheckpoint_FailFastWhenFailed(), TestCheckpoint_RunsAndPersistsContextOnSuccess(), TestCheckpoint_SkipsWhenDone(), TestConnectServiceToVpnHandler_HappyPath_EndToEnd(), copyToVolumeTask() (+34 more)
...
Cohesion: 0.09
Nodes (13): AssembleConfigJobSuite, AssembleConfigSuite, Context, runner[T], Context, Suite, Test_AssembleConfigJob(), Context (+5 more)

### Community 161 - "pkg/web (VcnApi)"
Cohesion: 0.20
Nodes (9): Smerd, Settings, SettingsBase, storeToLocalStorage(), useSettings(), SmerdCard(), ListSmerds(), DeployWidget() (+1 more)
...
Cohesion: 0.07
Nodes (22): ConnectServiceToVcn, GetVcnAuthKeyReq, IssueClientKey, ListVpnNamespaces, RegisterVcnNodeReq, VcnAuthKey, VcnNamespace, Context (+14 more)
...
Cohesion: 0.18
Nodes (6): ClusterStateManager, Storage, Pointer, NewContainer(), stateManager, ServiceDependenciesStorage
...
Cohesion: 0.10
Nodes (19): Agent code of conduct, API (Proto definitions in `api/grpc/`), Architecture, Building, Code Generation, Code Style, Commands, Configuration (+11 more)
...
Cohesion: 0.11
Nodes (8): Context, Querier, checkpointedJob, localStorage, DeploymentsStorage, JobsStorage, Storage, TasksStorage
...
Cohesion: 0.12
Nodes (4): MessageState, CreateDeploy_Response, GetServiceMetrics, StopService
...
Cohesion: 0.11
Nodes (19): APIClient, Context, Docker, MatreshkaConfigSpec, PlainConfigSpec, NewCreateSmerdHandler(), copyToContainerJob, createContainerJob (+11 more)
...
Cohesion: 0.12
Nodes (9): assembleConfigHandler, copyToVolumeHandler, createSmerdHandler, Job, NamedJob, RollbackableJob, TaskContext, testHandler (+1 more)
...
Cohesion: 0.23
Nodes (8): NewTxManager(), Docker, Storage, VervService, New(), ContainerService, TxManager, EnvironmentsStorageContainer
...
Cohesion: 0.09
Nodes (4): Message, CreateService_Response, GetServiceResources, RestartService_Request
...
Cohesion: 0.25
Nodes (4): createPgUserStep, CreatePgUserForNode(), Context, initNodeStorageJob
...
### Community 336 - "internal/domain (AssembleConfig)"
Cohesion: 0.22
...
Cohesion: 0.11
Nodes (23): Port, Volume, Checkbox(), CheckboxProps, InfoMark(), InfoMarkProps, Search(), SearchParam (+15 more)
...
### Community 433 - "GetConfig_Response"
Cohesion: 0.22
Nodes (4): ConfigurationPatch, Configurator, MatreshkaBeAPI_SubscribeOnChangesClient, handleSubscriptionStream()
...
### Community 447 - "UpsertServiceState"
Cohesion: 0.33
...
### Community 485 - "PrepareImage"
Cohesion: 0.43
Nodes (5): Context, Docker, InspectResponse, PrepareImage(), stepPrepareImage

### Community 487 - "FetchConfig"
Cohesion: 0.40
Nodes (5): isCreateSmerd_Request_Config, FetchConfig(), InspectResponse, isPostgresByImageTags(), isVervImage()
...
### Community 498 - "ListServices"
Cohesion: 0.12
Nodes (4): SizeCache, GetVervonomicon_Response, ListServices, RestartService

### Community 499 - ".ListSmerds"
Cohesion: 0.40
Nodes (4): CheckSidecarExist(), Context, Docker, checkSidecarExist

### Community 500 - "DeploymentFilters.tsx"
Cohesion: 0.33
...
### Community 748 - ".GetServiceEnvironments"
Cohesion: 0.40
...
## Knowledge Gaps
- **1111 isolated node(s):** `status.sh script`, `go.vervstack.ru/Velez`, `UnsafeMatreshkaApiServer`, `UnsafeControlPlaneAPIServer`, `UnsafeServiceApiServer` (+1106 more)
...
- **Why does `T` connect `tests/e2e (T)` to `tests/e2e (suite_hello_world_cluster_test.go)`, `internal/service (list_test.go)`, `internal/transport (deploy_list.go)`, `internal/pipelines (Step)`, `tests/e2e (NewEnvironment())`, `internal/pipelines (ConnectServiceToVpn())`, `internal/clients (create.go)`, `internal/clients (PortManager)`, `internal/storage (service_dependencies.go)`, `CopyToVolumeTaskPayload`, `pkg/web (ControlPlanePage.tsx)`, `pkg/web (fetch.pb.ts)`, `internal/api (ConfigBase)`?**
  _High betweenness centrality (0.147) - this node is a cross-community bridge._
- **Why does `file_velez_common_proto_init()` connect `internal/api (velez_common.pb.go)` to `internal/api (GetVervonomicon_Request)`, `internal/api (velez_api.pb.go)`, `internal/api (control_plane_api.pb.go)`, `pkg/web (package.json)`?**
