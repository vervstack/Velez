...
## Corpus Check
- 580 files · ~280,847 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 6690 nodes · 11370 edges · 700 communities (357 shown, 343 thin omitted)
- Extraction: 95% EXTRACTED · 5% INFERRED · 0% AMBIGUOUS · INFERRED: 610 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `65dac3c1`
...
- **Velez Configuration Environment Variable Schema** — config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_configyaml, config_configtemplate, docs_configuration [INFERRED 0.90]
...
## Communities (700 total, 343 thin omitted)
...
Cohesion: 0.04
Nodes (75): Absent, BaseEnableHeadscaleServer, BaseEnablePluginRequest, ConnectSlave, ConnectSlaveRequest, ConnectSlaveResponse, ControlPlaneAPI, EnableHeadscaleServer (+67 more)

### Community 9 - "pkg/web (ServiceInfoPage.tsx)"
Cohesion: 0.04
Nodes (65): ServiceBaseInfo, SmerdStatus, Toast, Toaster, useToaster, TagChip(), TagChipProps, SkeletonLoader() (+57 more)
...
Cohesion: 0.09
Nodes (4): file_service_api_proto_rawDescGZIP(), GetServiceEnvironments, GetServiceGraph, RemoveService_Response

### Community 27 - "internal/app (custom.go)"
Cohesion: 0.13
Nodes (10): ConnectUserRequest, VcnApi, InitReq, Errors, GrpcError, parseGrpcError(), ServiceError, ConnectUserToVcn() (+2 more)
...
Cohesion: 0.12
Nodes (4): MessageState, CreateService_Response, RemoveService, RestartService
...
Cohesion: 0.07
Nodes (35): ClusterClients, Impl, App, Custom, Context, parseLogLevel(), smerdsDropper(), Context (+27 more)
...
Cohesion: 0.05
Nodes (35): Absent, AssembleConfig, AssembleConfigRequest, AssembleConfigResponse, BaseCreateSmerdRequest, BreakConnections, BreakConnectionsRequest, BreakConnectionsResponse (+27 more)
...
Cohesion: 0.03
Nodes (76): AssembleConfigTaskPayload, ConnectServiceToVpnTaskPayload, CopyToVolumeTaskPayload, CreateServiceTaskPayload, CreateSmerdTaskPayload, DropSmerdTaskPayload, EnableStatefullTaskPayload, TasksApi (+68 more)
...
Cohesion: 0.12
Nodes (4): UnknownFields, GetService, GetVervonomicon, ListServices
...
Cohesion: 0.09
Nodes (16): pipeliner, FromContainerToRequest(), Context, NetworkBind, Smerd, APIClient, Context, RenameContainer() (+8 more)
...
Cohesion: 0.05
Nodes (34): CreateServiceRequest, Credentials, ls, useCredentialsStore, Button(), ButtonProps, InputProps, StyleProps (+26 more)
...
Cohesion: 0.12
Nodes (4): SizeCache, CreateDeploy_Response, GetServiceMetrics, ListDeployments
...
- **Why does `file_velez_common_proto_init()` connect `pkg/web (VervClosedNetworkPage.tsx)` to `internal/pipelines (.UpgradeSmerd())`, `internal/api (control_plane_api.pb.go)`, `GetConfigNode_Response`, `ListDeployments`?**
  _High betweenness centrality (0.165) - this node is a cross-community bridge._
- **Why does `T` connect `tests/e2e (T)` to `tests/e2e (suite_hello_world_cluster_test.go)`, `internal/service (list_test.go)`, `internal/transport (deploy_list.go)`, `internal/pipelines (Step)`, `internal/config (launch.go)`, `tests/e2e (NewEnvironment())`, `internal/pipelines (ConnectServiceToVpn())`, `internal/clients (create.go)`, `pkg/web (index.ts)`, `.enrichServiceWithSmerdData`, `CreatePgUserForNode`, `pkg/web (ControlPlanePage.tsx)`, `pkg/web (fetch.pb.ts)`, `internal/api (ConfigBase)`?**
  _High betweenness centrality (0.165) - this node is a cross-community bridge._
