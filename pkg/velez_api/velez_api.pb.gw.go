...
func RegisterVelezAPIHandlerServer(ctx context.Context, mux *runtime.ServeMux, server VelezAPIServer) error {
	...
	mux.Handle("POST", pattern_VelezAPI_Version_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/velez_api.VelezAPI/Version", runtime.WithHTTPPathPattern("/v1/version"))
		if err != nil {
...
func RegisterVelezAPIHandlerClient(ctx context.Context, mux *runtime.ServeMux, client VelezAPIClient) error {
	...
	mux.Handle("POST", pattern_VelezAPI_Version_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/velez_api.VelezAPI/Version", runtime.WithHTTPPathPattern("/v1/version"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
...
var (
	pattern_VelezAPI_Version_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"v1", "version"}, ""))
)
