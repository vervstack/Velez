    ...
    return (
        <div className={cls.VervClosedNetworkPageContainer}>
            ...
            <div className={cls.StatsGrid}>
                ...
                <StatCard value={activeCount} label="Active tunnels" level={Level.Good}/>
                <StatCard value={totalRx} label="Total RX" level={Level.INFO}/>
                <StatCard value={totalTx} label="Total TX" level={Level.INFO}/>
            </div>
