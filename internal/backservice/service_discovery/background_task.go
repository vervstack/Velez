...
func (s *ServiceDiscovery) Start() error {
...
func (s *ServiceDiscovery) GetName() string {
	return Name
}

func (s *ServiceDiscovery) GetDuration() time.Duration {
	return b.duration
}

func (s *ServiceDiscovery) IsAlive() (bool, error) {
	name := Name
...
func (s *ServiceDiscovery) Kill() error {
