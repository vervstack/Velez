...
## Corpus Check
- 597 files · ~290,852 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 6770 nodes · 11544 edges · 707 communities (367 shown, 340 thin omitted)
- Extraction: 94% EXTRACTED · 6% INFERRED · 0% AMBIGUOUS · INFERRED: 647 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `10fbdf9e`
...
- **Velez Configuration Environment Variable Schema** — config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_configyaml, config_configtemplate, docs_configuration [INFERRED 0.90]
...
## Communities (707 total, 340 thin omitted)
...
Cohesion: 0.08
Nodes (25): parseLogLevel(), smerdsDropper(), Badge(), BadgeProps, Level, StatCard(), StatCardProps, CodeBlock() (+17 more)
...
Cohesion: 0.06
Nodes (34): ConfigFormat, Connection, Container, ContainerHardware, ContainerHealthcheck, ContainerSettings, FileConfig, Image (+26 more)
...
Cohesion: 0.06
Nodes (82): T, TestCreateSmerdRequest_NilVervAndPlainStayNil(), TestCreateSmerdRequest_PlainSurvivesRoundTrip(), TestCreateSmerdRequest_SurvivesRoundTripEmbeddedInTaskPayload(), TestCreateSmerdRequest_VervAndPlainBothSurviveRoundTrip(), TestCreateSmerdRequest_VervSurvivesRoundTrip(), TestUpgradeSmerdRequest_SurvivesRoundTripEmbeddedInTaskPayload(), Time (+74 more)
...
Cohesion: 0.08
Nodes (21): Dialog(), DialogManager, useDialog, HeadscalePluginForm(), SimplePluginForm(), TestContext, Step, StepScreenProps (+13 more)
...
Cohesion: 0.09
Nodes (22): ListServicesReq, Paging, Context, ServiceBaseInfo, VervService, mapSmerdStatus(), Connection, Context (+14 more)
...
Cohesion: 0.13
Nodes (9): FromContainerToRequest(), Context, NetworkBind, Smerd, Context, upgradeSmerdHandler, ContainerService, fromContainerToRequest (+1 more)
...
Cohesion: 0.10
Nodes (17): Context, Duration, VelezTask, NewEngine(), Impl, New(), ConnectService_Request, ConnectService_Response (+9 more)
...
Cohesion: 0.12
Nodes (5): file_service_api_proto_init(), init(), GetService_Response_VervService, RestartService_Response, VervAppService
...
Cohesion: 0.12
Nodes (21): RollMigration(), getExposedPgPort(), Context, InspectResponse, CreatePgUserForNode(), Step, containerIDAccessor, containerInspectAPI (+13 more)
...
Cohesion: 0.07
Nodes (22): CopyToContainerOptions, GetVcnAuthKeyReq, VcnAuthKey, Context, Client, Context, EndpointSettings, Mutex (+14 more)
...
Cohesion: 0.05
Nodes (55): ControlPlaneAPI, EnableHeadscaleServer, EnableStatefullCluster, ListEnvironmentsResponse, ListNodesResponse, VervPlugin, VervPluginState, VervPluginType (+47 more)
...
Cohesion: 0.13
Nodes (16): getConfigFromContainerStep, copyToContainerStep, ConfigMount, FileMountPoint, APIClient, Context, ReadFromContainer(), WriteToContainer() (+8 more)
...
Cohesion: 0.07
Nodes (57): CopyToVolumeTaskPayload, EnableStatefullTaskPayload, App, NewAssembleConfigHandler(), Checkpoint(), Context, TestCheckpoint_FailFastWhenFailed(), TestCheckpoint_RunsAndPersistsContextOnSuccess() (+49 more)
...
Cohesion: 0.16
Nodes (11): Code, fetchConfigStep, RespError, FetchConfig(), Context, FileConfig, InspectResponse, MatreshkaConfigSpec (+3 more)
...
Cohesion: 0.12
Nodes (3): file_control_plane_api_proto_rawDescGZIP(), ConnectSlave_Request, ListVervPlugins_Request
...
Cohesion: 0.09
Nodes (17): Context, Docker, Container, NewEnableStatefullHandler(), patchEnableStatefullDockerFields(), TestEnableStatefullHandler_Action(), TestEnableStatefullHandler_NewContext(), copyToVolumeHandler (+9 more)
...
Cohesion: 0.18
Nodes (3): UnknownFields, AssembleConfig, BreakConnections_Response
...
### Community 495 - "GetServiceResources"
Cohesion: 0.12
Nodes (4): UnknownFields, CreateService, GetService, GetServiceResources
...
Cohesion: 0.18
Nodes (3): SizeCache, BreakConnections, GetHardware
...
## Knowledge Gaps
- **1059 isolated node(s):** `status.sh script`, `go.vervstack.ru/Velez`, `UnsafeMatreshkaApiServer`, `UnsafeControlPlaneAPIServer`, `UnsafeServiceApiServer` (+1054 more)
...
- **Why does `T` connect `pkg/web (index.ts)` to `internal/api (GetHardware_Request)`, `internal/service (list_test.go)`, `internal/config (launch.go)`, `pkg/web (verv_closed_network.pb.ts)`, `internal/pipelines (create_and_inspect.go)`, `pkg/web (ResourcesSection.tsx)`, `tests/e2e (NewEnvironment())`, `internal/pipelines (ConnectServiceToVpn())`, `runner`, `internal/clients (hardware_manager.go)`, `internal/transport (grpcServer)`, `internal/pipelines (do_copy_to_volume.go)`, `pkg/web (Router.tsx)`, `CreatePgUserForNode`, `pkg/web (ControlPlanePage.tsx)`, `internal/api (UnknownFields)`, `tests/e2e (suite_hello_world_cluster_test.go)`?**
  _High betweenness centrality (0.182) - this node is a cross-community bridge._
- **Why does `file_velez_common_proto_init()` connect `internal/clients (api_key_issue.go)` to `internal/api (Message)`, `internal/storage (docker_impl.go)`, `internal/api (control_plane_api.pb.go)`, `GetConfigNode_Response`?**
