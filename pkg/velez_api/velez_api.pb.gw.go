...
func RegisterVelezAPIHandlerServer(ctx context.Context, mux *runtime.ServeMux, server VelezAPIServer) error {
	...
	mux.Handle(http.MethodPost, pattern_VelezAPI_FetchConfig_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		ctx, cancel := context.WithCancel(req.Context())
		defer cancel()
		var stream runtime.ServerTransportStream
		ctx = grpc.NewContextWithServerTransportStream(ctx, &stream)
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		annotatedContext, err := runtime.AnnotateIncomingContext(ctx, mux, req, "/velez_api.VelezAPI/FetchConfig", runtime.WithHTTPPathPattern("/api/smerd/fetch-config"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
...
func RegisterVelezAPIHandlerClient(ctx context.Context, mux *runtime.ServeMux, client VelezAPIClient) error {
	...
	mux.Handle(http.MethodPost, pattern_VelezAPI_FetchConfig_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		defer cancel()
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		annotatedContext, err := runtime.AnnotateContext(ctx, mux, req, "/velez_api.VelezAPI/FetchConfig", runtime.WithHTTPPathPattern("/api/smerd/fetch-config"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
...
var (
	...
	pattern_VelezAPI_FetchConfig_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"api", "smerd", "fetch-config"}, ""))
)
