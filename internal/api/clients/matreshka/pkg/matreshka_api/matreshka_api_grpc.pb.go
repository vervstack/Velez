...
type MatreshkaApiClient interface {
	...
	SubscribeOnChanges(ctx context.Context, opts ...grpc.CallOption) (MatreshkaApi_SubscribeOnChangesClient, error)
}
...
func (c *matreshkaApiClient) Version(ctx context.Context, in *Version_Request, opts ...grpc.CallOption) (*Version_Response, error) {
	...
	err := c.cc.Invoke(ctx, MatreshkaApi_Version_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *matreshkaApiClient) ListConfigs(ctx context.Context, in *ListConfigs_Request, opts ...grpc.CallOption) (*ListConfigs_Response, error) {
	...
	err := c.cc.Invoke(ctx, MatreshkaApi_ListConfigs_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *matreshkaApiClient) CreateConfig(ctx context.Context, in *CreateConfig_Request, opts ...grpc.CallOption) (*CreateConfig_Response, error) {
	...
	err := c.cc.Invoke(ctx, MatreshkaApi_CreateConfig_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *matreshkaApiClient) SaveConfig(ctx context.Context, in *SaveConfig_Request, opts ...grpc.CallOption) (*SaveConfig_Response, error) {
	...
	err := c.cc.Invoke(ctx, MatreshkaApi_SaveConfig_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *matreshkaApiClient) GetConfig(ctx context.Context, in *GetConfig_Request, opts ...grpc.CallOption) (*GetConfig_Response, error) {
	...
	err := c.cc.Invoke(ctx, MatreshkaApi_GetConfig_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *matreshkaApiClient) GetConfigNodes(ctx context.Context, in *GetConfigNode_Request, opts ...grpc.CallOption) (*GetConfigNode_Response, error) {
	...
	err := c.cc.Invoke(ctx, MatreshkaApi_GetConfigNodes_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *matreshkaApiClient) PatchConfig(ctx context.Context, in *PatchConfig_Request, opts ...grpc.CallOption) (*PatchConfig_Response, error) {
	...
	err := c.cc.Invoke(ctx, MatreshkaApi_PatchConfig_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *matreshkaApiClient) RenameConfig(ctx context.Context, in *RenameConfig_Request, opts ...grpc.CallOption) (*RenameConfig_Response, error) {
	...
	err := c.cc.Invoke(ctx, MatreshkaApi_RenameConfig_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *matreshkaApiClient) DeleteConfig(ctx context.Context, in *DeleteConfig_Request, opts ...grpc.CallOption) (*DeleteConfig_Response, error) {
	...
	err := c.cc.Invoke(ctx, MatreshkaApi_DeleteConfig_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *matreshkaApiClient) SubscribeOnChanges(ctx context.Context, opts ...grpc.CallOption) (MatreshkaApi_SubscribeOnChangesClient, error) {
	stream, err := c.cc.NewStream(ctx, &MatreshkaApi_ServiceDesc.Streams[0], MatreshkaApi_SubscribeOnChanges_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
	x := &matreshkaApiSubscribeOnChangesClient{stream}
	return x, nil
}

type MatreshkaApi_SubscribeOnChangesClient interface {
	Send(*SubscribeOnChanges_Request) error
	Recv() (*SubscribeOnChanges_Response, error)
	grpc.ClientStream
}

type matreshkaApiSubscribeOnChangesClient struct {
	grpc.ClientStream
}

func (x *matreshkaApiSubscribeOnChangesClient) Send(m *SubscribeOnChanges_Request) error {
	return x.ClientStream.SendMsg(m)
}

func (x *matreshkaApiSubscribeOnChangesClient) Recv() (*SubscribeOnChanges_Response, error) {
...
type MatreshkaApiServer interface {
	...
	SubscribeOnChanges(MatreshkaApi_SubscribeOnChangesServer) error
	mustEmbedUnimplementedMatreshkaApiServer()
}

// UnimplementedMatreshkaApiServer must be embedded to have forward compatible implementations.
...
func (UnimplementedMatreshkaApiServer) SubscribeOnChanges(MatreshkaApi_SubscribeOnChangesServer) error {
...
func _MatreshkaApi_SubscribeOnChanges_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(MatreshkaApiServer).SubscribeOnChanges(&matreshkaApiSubscribeOnChangesServer{stream})
}

type MatreshkaApi_SubscribeOnChangesServer interface {
	Send(*SubscribeOnChanges_Response) error
	Recv() (*SubscribeOnChanges_Request, error)
	grpc.ServerStream
}

type matreshkaApiSubscribeOnChangesServer struct {
	grpc.ServerStream
}

func (x *matreshkaApiSubscribeOnChangesServer) Send(m *SubscribeOnChanges_Response) error {
	return x.ServerStream.SendMsg(m)
}

func (x *matreshkaApiSubscribeOnChangesServer) Recv() (*SubscribeOnChanges_Request, error) {
