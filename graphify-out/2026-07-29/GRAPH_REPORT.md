...
- **Velez Configuration Environment Variable Schema** — config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_configyaml, config_configtemplate, docs_configuration [INFERRED 0.90]
...
Cohesion: 0.20
Nodes (10): Deployment, DeploymentList, DeploymentSpecification, ListDeploymentsReq, Paging, Time, VelezDeploymentStatus, Context (+2 more)
...
Cohesion: 0.07
Nodes (13): Pointer, Storage, Querier, fakeClusterStorage, localStorage, Container, DeploymentsStorage, JobsStorage (+5 more)
...
Cohesion: 0.10
Nodes (12): TasksApi, GetHardwareResponse, ListSmerdsRequest, ListSmerdsResponse, SearchImagesResponse, VelezAPI, toProto(), DeploySmerd() (+4 more)
...
Cohesion: 0.09
Nodes (44): proto(), TestCreateSidecarContainerJob_Success(), TestStartSidecarContainerJob_ContainerStartError(), TestStartSidecarContainerJob_Rollback_StopsContainer(), TestCopyFileJob_CopyToContainerError(), TestCopyFileJob_ExecError(), TestStartLoaderContainerJob_ContainerStartError(), TestStartLoaderContainerJob_Rollback_NoContainerId_NoOp() (+36 more)
...
Cohesion: 0.08
Nodes (9): MessageState, SizeCache, UnknownFields, ConnectSlave, ConnectSlave_Request, ConnectSlave_Response, EnablePlugin_Response, InitMaster (+1 more)
...
Cohesion: 0.07
Nodes (41): HelloWorldClusterSuite, T, TestCreateSmerdRequest_NilVervAndPlainStayNil(), TestCreateSmerdRequest_PlainSurvivesRoundTrip(), TestCreateSmerdRequest_SurvivesRoundTripEmbeddedInTaskPayload(), TestCreateSmerdRequest_VervAndPlainBothSurviveRoundTrip(), TestCreateSmerdRequest_VervSurvivesRoundTrip(), TestUpgradeSmerdRequest_SurvivesRoundTripEmbeddedInTaskPayload() (+33 more)
...
Cohesion: 0.06
Nodes (41): EnvCard(), EnvCardProps, ServiceEnvironment, ServiceGraphNode, ServiceResource, VervonomiconDocs, ListEnvironmentsQuery(), LIST_REQ (+33 more)

### Community 49 - "internal/pipelines (do_copy_to_volume.go)"
Cohesion: 0.07
Nodes (21): ConnectService, ConnectServiceRequest, ConnectServiceResponse, ConnectUser, ConnectUserRequest, ConnectUserResponse, CreateVcnNamespace, CreateVcnNamespaceRequest (+13 more)

### Community 50 - "internal/clients (NodeClients)"
Cohesion: 0.10
Nodes (11): CreateOptions, Context, APIClient, CreateResponse, ExecOptions, HostConfig, InspectResponse, NetworkingConfig (+3 more)

### Community 51 - "internal/pipelines (.UpgradeSmerd())"
Cohesion: 0.07
Nodes (29): ListNodesResponse, SectionLabel(), SectionLabelProps, Level, StatCard(), StatCardProps, CodeBlock(), CodeBlockProps (+21 more)
...
Cohesion: 0.07
Nodes (51): NewAssembleConfigHandler(), TestAssembleConfigHandler_Action(), TestAssembleConfigHandler_NewContext(), TestClassifyImage(), TestCreateScratchContainerJob_ContainerCreateError(), TestCreateScratchContainerJob_Rollback_NoContainerId_NoOp(), TestCreateScratchContainerJob_Rollback_NotFoundIsSwallowed(), TestCreateScratchContainerJob_Rollback_RemoveErrorPropagates() (+43 more)
...
Cohesion: 0.08
Nodes (24): PluginBaseInfo, New(), NewTxManager(), DeploymentStatus, VervPlugin_State, Queries, newDeploymentsStorage(), Queries (+16 more)
...
Cohesion: 0.08
Nodes (22): LaunchSmerd, LaunchSmerdResult, CreateSmerd_Request, pipeliner, APIClient, Context, Healthcheck(), FromContainerToRequest() (+14 more)
...
Cohesion: 0.08
Nodes (19): CopyToContainerOptions, VcnAuthKey, Context, EndpointSettings, Mutex, Service, Summary, fakeContainerAPI (+11 more)
...
Cohesion: 0.06
Nodes (12): storeConfigStep, file_matreshka_common_proto_rawDescGZIP(), EnumDescriptor, EnumNumber, EnumType, Configurator, Context, StoreConfig() (+4 more)
...
Cohesion: 0.08
Nodes (20): VcnNamespace, createNamespaceRequest, createNamespaceResponse, getNamespaceResponse, listNamespacesResponse, Context, Client, Context (+12 more)

### Community 142 - "internal/pipelines (create.go)"
Cohesion: 0.04
Nodes (20): file_matreshka_common_proto_init(), Message, MessageState, SizeCache, Timestamp, UnknownFields, init(), fromApiNodes() (+12 more)

### Community 143 - "internal/api (CreateDeploy_Request)"
Cohesion: 0.12
Nodes (24): NewConnectServiceToVpnHandler(), TestAddMakoshRecordJob_Success(), TestAddMakoshRecordJob_UpsertError(), TestConnectServiceToVpnHandler_Action(), TestConnectServiceToVpnHandler_BuildJobs_NamesAndOrder(), TestConnectServiceToVpnHandler_NewContext(), TestCreateSidecarContainerJob_ContainerCreateError(), TestCreateSidecarContainerJob_Rollback_NotFoundIsSwallowed() (+16 more)
...
Cohesion: 0.09
Nodes (47): CopyToVolumeTaskPayload, App, Checkpoint(), Context, TestCheckpoint_FailFastWhenFailed(), TestCheckpoint_RunsAndPersistsContextOnSuccess(), TestCheckpoint_SkipsWhenDone(), TestConnectServiceToVpnHandler_FailurePath_CreateContainerFails() (+39 more)
...
Cohesion: 0.12
Nodes (15): Code, fetchConfigStep, copyToContainerStep, FileMountPoint, RespError, FetchConfig(), Context, FileConfig (+7 more)
...
Cohesion: 0.09
Nodes (17): ConnectServiceToVcn, GetVcnAuthKeyReq, IssueClientKey, ListVpnNamespaces, RegisterVcnNodeReq, SetupHeadscaleRequest, SetupHeadscaleResponse, Context (+9 more)
...
Cohesion: 0.12
Nodes (10): InputProps, StyleProps, KeyValueProps, PlainMapProps, Search(), SearchParam, SearchProps, PortMapping() (+2 more)
...
Cohesion: 0.09
Nodes (16): patchStartAPIField(), Context, Docker, Container, Docker, assembleConfigHandler, dropContainerJob, dropResultAccessor (+8 more)
...
Cohesion: 0.14
Nodes (13): Context, Duration, VelezTask, NewEngine(), TestEngine_EnqueueDedupesConcurrentCalls(), TestEngine_EnqueueReturnsExistingFailedTaskInstead(), Impl, New() (+5 more)
...
- **Why does `T` connect `internal/pipelines (ConnectServiceToVpn())` to `internal/pipelines (Step)`, `pkg/web (ResourcesSection.tsx)`, `internal/clients (hardware_manager.go)`, `internal/api (CreateDeploy_Request)`, `internal/transport (grpcServer)`, `pkg/web (Router.tsx)`, `pkg/web (ControlPlanePage.tsx)`, `internal/api (file_control_plane_api_proto_rawDescGZIP())`, `tests/e2e (suite_hello_world_cluster_test.go)`, `internal/config (launch.go)`, `tests/e2e (T)`, `CreatePgUserForNode`, `internal/patterns (headscale.go)`, `tests/e2e (NewEnvironment())`, `internal/api (GetConfig_Request)`, `NodeStatusFromLastOnline`, `NewEngine`, `internal/api (ListPlugins_Request)`, `internal/api (ConfigBase)`?**
  _High betweenness centrality (0.168) - this node is a cross-community bridge._
- **Why does `file_velez_common_proto_init()` connect `internal/storage (node.go)` to `internal/api (velez_api.pb.go)`, `internal/api (UpgradeSmerd)`, `internal/api (control_plane_api.pb.go)`, `GetConfigNode_Response`?**
  _High betweenness centrality (0.163) - this node is a cross-community bridge._
- **Why does `Port_Protocol` connect `internal/storage (EnvironmentsStorage)` to `internal/service (configurator.go)`, `internal/api (EnumNumber)`, `pkg/web (Input.tsx)`, `internal/storage (node.go)`?**
