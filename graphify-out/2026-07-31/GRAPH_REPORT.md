...
## Corpus Check
- 599 files · ~294,217 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 6829 nodes · 11728 edges · 706 communities (364 shown, 342 thin omitted)
...
- **Velez Configuration Environment Variable Schema** — config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_configyaml, config_configtemplate, docs_configuration [INFERRED 0.90]
...
## Communities (706 total, 342 thin omitted)
...
Cohesion: 0.07
Nodes (33): EnvCard(), EnvCardProps, ServiceEnvironment, ServiceGraphNode, ServiceResource, VervonomiconDocs, IsStatefullModeEnabled(), ListEnvironmentsQuery() (+25 more)
...
Cohesion: 0.07
Nodes (69): T, TestCreateSmerdRequest_NilVervAndPlainStayNil(), TestCreateSmerdRequest_PlainSurvivesRoundTrip(), TestCreateSmerdRequest_SurvivesRoundTripEmbeddedInTaskPayload(), TestCreateSmerdRequest_VervAndPlainBothSurviveRoundTrip(), TestCreateSmerdRequest_VervSurvivesRoundTrip(), TestUpgradeSmerdRequest_SurvivesRoundTripEmbeddedInTaskPayload(), Time (+61 more)
...
Cohesion: 0.05
Nodes (38): Absent, BaseEnableHeadscaleServer, BaseEnablePluginRequest, ConnectSlave, ConnectSlaveRequest, ConnectSlaveResponse, EnableHeadscaleServerDeployHeadscaleConfig, EnableHeadscaleServerExternalHeadscaleConnection (+30 more)
...
Cohesion: 0.07
Nodes (26): Context, Duration, VelezTask, Context, GetServiceEnvironments_Request, GetServiceEnvironments_Response, Impl, Context (+18 more)
...
Cohesion: 0.10
Nodes (15): Step, StepScreenProps, StepsDialog(), StepsDialogProps, TestContext, StepsDialogHeader(), StepsDialogHeaderContent, StepsDialogHeaderProps (+7 more)
...
Cohesion: 0.08
Nodes (9): MessageState, SizeCache, UnknownFields, ConnectSlave, ConnectSlave_Request, ListEnvironments_Request, ListNodes, ListPlugins (+1 more)
...
Cohesion: 0.15
Nodes (18): newFakeContainerService(), realPortManager(), strPtr(), TestCaptureOldContainerJob_InspectError(), TestCaptureOldContainerJob_Success(), TestCheckSelfUpgradeJob_NotInsideContainer_NoOp(), TestGetConfigFromScratchContainerJob_EmptyContainerId_Error(), TestGetConfigFromScratchContainerJob_NonVervImage_NoOp() (+10 more)

### Community 42 - "internal/pipelines (ConfigurationService)"
Cohesion: 0.09
Nodes (21): TasksApi, VelezAPI, toProto(), GetInitReq(), InitReq, keyPath(), pathPrefixPath(), StoreApiKey() (+13 more)
...
Cohesion: 0.10
Nodes (22): APIClient, Context, CreateSmerd_Request, Docker, FileConfig, MatreshkaConfigSpec, containerIDAccessor, copyToContainerJob (+14 more)
...
Cohesion: 0.08
Nodes (46): Code, RespError, proto(), TestStartSidecarContainerJob_ContainerStartError(), TestStartSidecarContainerJob_Rollback_StopsContainer(), TestStartSidecarContainerJob_Success(), TestStartLoaderContainerJob_ContainerStartError(), TestStartLoaderContainerJob_NoContainerId_Error() (+38 more)
...
Cohesion: 0.11
Nodes (21): Custom, ClusterClients, Impl, App, Context, NewSecurityManager(), Container, Context (+13 more)
...
Cohesion: 0.11
Nodes (22): getExposedPgPort(), Container, Context, InspectResponse, CreatePgUserForNode(), Step, containerInspectAPI, createPgContainerJob (+14 more)
...
Cohesion: 0.10
Nodes (15): HelloWorldClusterSuite, UpgradeSmerdSuite, addTestLabels(), AssertSmerds(), CreateSmerd_Request, Smerd, GetExpectedLabels(), GetServiceName() (+7 more)

### Community 94 - "pkg/web (Input.tsx)"
Cohesion: 0.08
Nodes (25): LaunchSmerd, LaunchSmerdResult, CreateSmerd_Request, pipeliner, pipeliner, FetchConfig(), APIClient, Context (+17 more)

### Community 99 - "internal/api (Message)"
Cohesion: 0.18
Nodes (3): MessageState, CreateSmerd, GetHardware
...
Cohesion: 0.10
Nodes (20): ConnectService, ConnectServiceRequest, ConnectServiceResponse, ConnectUser, ConnectUserRequest, ConnectUserResponse, CreateVcnNamespace, CreateVcnNamespaceRequest (+12 more)
...
Cohesion: 0.09
Nodes (24): New(), RollMigration(), NewTxManager(), Queries, newDeploymentsStorage(), Queries, newJobsStorage(), newNodeStorage() (+16 more)
...
Cohesion: 0.05
Nodes (43): ListNodesResponse, NodeBaseInfo, NodeStatus, MainLayout(), NAV_TO_ROUTE, NavId, ROUTE_TO_NAV, TOOL_TO_ROUTE (+35 more)
...
Cohesion: 0.15
Nodes (14): CreateDeployReq, RemoveServiceReq, UpgradeDeployReq, Context, VervService, TestCreateNewDeploy_GetByNameError(), TestUpgradeDeploy_GetByNameError(), Context (+6 more)
...
Cohesion: 0.18
Nodes (3): SizeCache, BreakConnections_Response, Version_Request
...
Cohesion: 0.12
Nodes (3): Message, EnablePlugin, ListEnvironments
...
- **Why does `T` connect `pkg/web (index.ts)` to `pkg/web (ResourcesSection.tsx)`, `ListEnvironments_Response`, `internal/clients (hardware_manager.go)`, `internal/transport (grpcServer)`, `pkg/web (ControlPlanePage.tsx)`, `tests/e2e (suite_hello_world_cluster_test.go)`, `internal/service (list_test.go)`, `internal/config (launch.go)`, `internal/pipelines (ConnectServiceToVpn())`, `internal/clients (api_key_issue.go)`, `internal/api (matreshka_common.pb.go)`, `internal/pipelines (do_copy_to_volume.go)`, `internal/api (Image)`, `CreatePgUserForNode`, `pkg/web (verv_closed_network.pb.ts)`, `internal/domain (service.go)`, `tests/e2e (NewEnvironment())`, `internal/storage (EnvironmentsStorage)`, `Context`, `internal/api (UnknownFields)`, `NewEngine`, `.enrichServiceWithSmerdData`?**
  _High betweenness centrality (0.192) - this node is a cross-community bridge._
- **Why does `file_velez_common_proto_init()` connect `pkg/web (Sidebar.tsx)` to `internal/api (velez_api.pb.go)`, `internal/api (UpgradeSmerd)`, `internal/api (control_plane_api.pb.go)`, `GetConfigNode_Response`?**
