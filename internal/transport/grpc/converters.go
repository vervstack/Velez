...
func getVolumes(settings *velez_api.Container_Settings) map[string]struct{} {
	if settings == nil {
		return nil
	}
...
func getPorts(settings *velez_api.Container_Settings) map[nat.Port][]nat.PortBinding {
	if settings == nil {
		return nil
	}
