...
## Corpus Check
- 569 files · ~286,034 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 6647 nodes · 11308 edges · 705 communities (368 shown, 337 thin omitted)
- Extraction: 94% EXTRACTED · 6% INFERRED · 0% AMBIGUOUS · INFERRED: 632 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `6a4f0f9e`
...
- **Velez Configuration Environment Variable Schema** — config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_configyaml, config_configtemplate, docs_configuration [INFERRED 0.90]
...
## Communities (705 total, 337 thin omitted)

### Community 0 - "internal/api (service_api.pb.gw.go)"
Cohesion: 0.06
Nodes (88): ClientConnInterface, Context, CreateDeploy_Request, CreateDeploy_Response, CreateService_Request, CreateService_Response, GetService_Request, GetService_Response (+80 more)
...
Cohesion: 0.04
Nodes (48): ServiceBaseInfo, Toast, Toaster, useToaster, Button(), ButtonProps, TagChip(), TagChipProps (+40 more)

### Community 11 - "internal/clients (create.go)"
Cohesion: 0.11
Nodes (18): CreateServiceRequest, ConnectionHealth, ConnectionHealthStatus, useConnectionHealth(), router, Arguments, useCredentialsStore, queryClient (+10 more)
...
Cohesion: 0.08
Nodes (8): Pointer, Storage, fakeClusterStorage, Container, NodesStorage, PluginsStorage, ServiceDependenciesStorage, ServiceResourcesStorage
...
Cohesion: 0.24
Nodes (7): Context, Docker, writeFileToContainer(), copyAPI, copyFileJob, dropLoaderContainerJob, startLoaderContainerJob
...
Cohesion: 0.10
Nodes (16): TasksApi, ListSmerdsRequest, ListSmerdsResponse, SearchImagesResponse, VelezAPI, toProto(), DeploySmerd(), DeploySmerdStream() (+8 more)
...
Cohesion: 0.08
Nodes (53): T, TestCreateSmerdRequest_NilVervAndPlainStayNil(), TestCreateSmerdRequest_PlainSurvivesRoundTrip(), TestCreateSmerdRequest_SurvivesRoundTripEmbeddedInTaskPayload(), TestCreateSmerdRequest_VervAndPlainBothSurviveRoundTrip(), TestCreateSmerdRequest_VervSurvivesRoundTrip(), TestUpgradeSmerdRequest_SurvivesRoundTripEmbeddedInTaskPayload(), Time (+45 more)
...
Cohesion: 0.08
Nodes (22): Checkbox(), CheckboxProps, InfoMark(), InfoMarkProps, InputProps, StyleProps, KeyValueProps, PlainMapProps (+14 more)
...
Cohesion: 0.10
Nodes (26): NewPortManager(), TestFetchSmerdConfigJob_SetEnv_CallerValueNotOverwritten(), TestFetchSmerdConfigJob_VervAndPlain_BothApply(), newFakeConfigurationService(), newFakeContainerService(), NewUpgradeSmerdHandler(), realPortManager(), strPtr() (+18 more)

### Community 42 - "internal/pipelines (ConfigurationService)"
Cohesion: 0.16
Nodes (11): subscribeForConfigChangesStep, unsubscribeForConfigChangesStep, NewCreateSmerdHandler(), Context, SubscribeForConfigChanges(), Context, UnSubscribeForConfigChanges(), APIClient (+3 more)
...
Cohesion: 0.10
Nodes (19): Context, CreateRequest, Docker, ServiceDiscovery, CreateRequest, TailScaleContainerSidecar(), addMakoshRecordJob, clientKeyAccessor (+11 more)
...
Cohesion: 0.06
Nodes (58): NewAssembleConfigHandler(), TestAssembleConfigHandler_Action(), TestAssembleConfigHandler_NewContext(), TestClassifyImage(), TestCreateScratchContainerJob_ContainerCreateError(), TestCreateScratchContainerJob_Rollback_NoContainerId_NoOp(), TestCreateScratchContainerJob_Rollback_NotFoundIsSwallowed(), TestCreateScratchContainerJob_Rollback_RemoveErrorPropagates() (+50 more)
...
Cohesion: 0.09
Nodes (23): New(), Queries, newDeploymentsStorage(), Queries, newJobsStorage(), Context, NodeBaseInfo, Querier (+15 more)
...
Cohesion: 0.12
Nodes (4): SizeCache, RemoveService, RemoveService_Response, RestartService_Response
...
Cohesion: 0.05
Nodes (45): ListNodesResponse, NodeBaseInfo, NodeStatus, MainLayout(), NAV_TO_ROUTE, NavId, ROUTE_TO_NAV, TOOL_TO_ROUTE (+37 more)
...
Cohesion: 0.08
Nodes (33): ControlPlaneAPI, EnableHeadscaleServer, EnableStatefullCluster, ListEnvironmentsResponse, VervPlugin, VervPluginState, VervPluginType, Dialog() (+25 more)
...
Cohesion: 0.18
Nodes (9): Context, Queries, BoundResource, Context, Queries, newServiceResourcesStorage(), wrapPgErr(), serviceDependenciesStorage (+1 more)
...
Cohesion: 0.10
Nodes (7): MessageState, SizeCache, UnknownFields, Container, Container_Hardware, PlainConfigSpec, RestartPolicy
...
Cohesion: 0.10
Nodes (44): CopyToVolumeTaskPayload, Checkpoint(), Context, TestCheckpoint_FailFastWhenFailed(), TestCheckpoint_RunsAndPersistsContextOnSuccess(), TestCheckpoint_SkipsWhenDone(), TestConnectServiceToVpnHandler_HappyPath_EndToEnd(), copyToVolumeTask() (+36 more)
...
Cohesion: 0.12
Nodes (3): file_velez_common_proto_rawDescGZIP(), NodeBaseInfo, NodeStatus
...
Cohesion: 0.11
Nodes (3): Message, GetService_Request, GetServiceResources_Request
...
Cohesion: 0.11
Nodes (9): Pointer, Context, Querier, checkpointedJob, stateManager, DeploymentsStorage, JobsStorage, Storage (+1 more)
...
Cohesion: 0.09
Nodes (16): patchStartAPIField(), Context, Docker, Container, patchEnableStatefullDockerFields(), Docker, copyToVolumeHandler, dropContainerJob (+8 more)
...
Cohesion: 0.07
Nodes (25): Context, Duration, VelezTask, NewEngine(), TestEngine_EnqueueDedupesConcurrentCalls(), TestEngine_EnqueueReturnsExistingFailedTaskInstead(), Context, GetServiceEnvironments_Request (+17 more)
...
Cohesion: 0.07
Nodes (24): VervClosedNetworkClient, clusterClients, Client, Configurator, Context, ServiceDiscovery, Setup(), Context (+16 more)
...
## Knowledge Gaps
- **1050 isolated node(s):** `status.sh script`, `go.vervstack.ru/Velez`, `UnsafeMatreshkaApiServer`, `UnsafeControlPlaneAPIServer`, `UnsafeServiceApiServer` (+1045 more)
...
- **Why does `T` connect `pkg/web (Router.tsx)` to `tests/e2e (suite_hello_world_cluster_test.go)`, `internal/service (list_test.go)`, `internal/config (launch.go)`, `internal/pipelines (Step)`, `pkg/web (services.ts)`, `NodeStatusFromLastOnline`, `tests/e2e (NewEnvironment())`, `internal/pipelines (ConnectServiceToVpn())`, `internal/api (CreateDeploy_Request)`, `internal/transport (grpcServer)`, `internal/pipelines (do_copy_to_volume.go)`, `tests/e2e (T)`, `CreatePgUserForNode`, `pkg/web (ControlPlanePage.tsx)`, `internal/api (InitMaster_Response)`, `internal/api (ListPlugins_Request)`, `internal/api (file_control_plane_api_proto_rawDescGZIP())`, `internal/api (ConfigBase)`?**
  _High betweenness centrality (0.184) - this node is a cross-community bridge._
- **Why does `file_velez_common_proto_init()` connect `Version_Response` to `internal/api (velez_common.pb.go)`, `internal/api (control_plane_api.pb.go)`, `GetConfigNode_Response`, `internal/api (UpgradeSmerd_Response)`?**
  _High betweenness centrality (0.166) - this node is a cross-community bridge._
- **Why does `NodeClients` connect `internal/clients (PortManager)` to `internal/pipelines (Step)`, `pkg/web (velez_api.pb.ts)`, `pkg/web (ResourcesSection.tsx)`, `internal/storage (Storage)`, `pkg/web (DeployWidget.tsx)`, `internal/api (CreateDeploy_Request)`, `pkg/web (Router.tsx)`, `pkg/web (ControlPlanePage.tsx)`, `getConfigFromContainerStep`, `pkg/web (VcnApi)`, `internal/config (launch.go)`, `.EnablePlugin`, `internal/pipelines (ConnectServiceToVpn())`, `internal/pipelines (ConfigurationService)`, `internal/api (matreshka_common.pb.go)`, `internal/pipelines (LaunchSmerd)`, `tests/e2e (T)`, `pkg/web (ServiceService)`, `pkg/web (Section.tsx)`, `internal/storage (docker_impl.go)`, `internal/domain (service.go)`, `internal/api (Message)`, `pkg/web (Input.tsx)`, `internal/api (GetService_Request)`, `pkg/web (control_plane.ts)`, `internal/api (GetHardware_Request)`, `tests/e2e (helper_environment.go)`?**
