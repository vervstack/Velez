...
## Corpus Check
- 606 files · ~297,556 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 6899 nodes · 11926 edges · 727 communities (385 shown, 342 thin omitted)
- Extraction: 94% EXTRACTED · 6% INFERRED · 0% AMBIGUOUS · INFERRED: 724 edges (avg confidence: 0.8)
...
- **Velez Configuration Environment Variable Schema** — config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_configyaml, config_configtemplate, docs_configuration [INFERRED 0.90]
...
## Communities (727 total, 342 thin omitted)
...
Cohesion: 0.06
Nodes (51): Toast, Toaster, useToaster, router, Arguments, AppCard(), AppCardProps, EnvChip() (+43 more)
...
Cohesion: 0.14
Nodes (5): fakeClusterStorage, DeploymentsStorage, NodesStorage, PluginsStorage, testStorage
...
Cohesion: 0.07
Nodes (61): CopyToVolumeTaskPayload, NewAssembleConfigHandler(), TestAssembleConfigHandler_Action(), TestAssembleConfigHandler_NewContext(), TestClassifyImage(), TestCreateScratchContainerJob_ContainerCreateError(), TestCreateScratchContainerJob_Rollback_NoContainerId_NoOp(), TestCreateScratchContainerJob_Rollback_NotFoundIsSwallowed() (+53 more)
...
Cohesion: 0.06
Nodes (35): ListNodesResponse, NodeBaseInfo, Badge(), BadgeProps, SectionLabel(), SectionLabelProps, isMetricAmber(), isMetricRed() (+27 more)
...
Cohesion: 0.12
Nodes (4): MessageState, CreateDeploy_Response, GetServiceEnvironments, RemoveService

### Community 27 - "internal/app (custom.go)"
Cohesion: 0.09
Nodes (15): FinalStepProps, Step, StepScreenProps, StepsDialogProps, TestContext, StepsDialogHeader(), StepsDialogHeaderContent, StepsDialogHeaderProps (+7 more)
...
Cohesion: 0.08
Nodes (9): MessageState, SizeCache, UnknownFields, ConnectSlave, ConnectSlave_Response, InitMaster, ListEnvironments_Request, ListPlugins (+1 more)
...
Cohesion: 0.09
Nodes (19): FromPaging(), Paging, Context, Impl, ListNodes_Request, ListNodes_Response, Context, DeploymentStatus (+11 more)
...
Cohesion: 0.07
Nodes (40): T, TestCreateSmerdRequest_NilVervAndPlainStayNil(), TestCreateSmerdRequest_PlainSurvivesRoundTrip(), TestCreateSmerdRequest_SurvivesRoundTripEmbeddedInTaskPayload(), TestCreateSmerdRequest_VervAndPlainBothSurviveRoundTrip(), TestCreateSmerdRequest_VervSurvivesRoundTrip(), TestUpgradeSmerdRequest_SurvivesRoundTripEmbeddedInTaskPayload(), Time (+32 more)
...
Cohesion: 0.03
Nodes (54): ServiceBaseInfo, ConfigFormat, Connection, Container, ContainerHardware, ContainerHealthcheck, ContainerSettings, FileConfig (+46 more)
...
Cohesion: 0.11
Nodes (22): DeploymentInfo, DeploymentStatus, CreateSmerdRequest, DeploymentStatusBadge(), DeploymentStatusBadgeProps, STATUS_COLOR, STATUS_DIM, SkeletonDeploymentHistory() (+14 more)
...
Cohesion: 0.08
Nodes (25): Absent, BaseEnableHeadscaleServer, BaseEnablePluginRequest, ConnectSlave, ConnectSlaveRequest, ConnectSlaveResponse, EnableHeadscaleServerDeployHeadscaleConfig, EnableHeadscaleServerExternalHeadscaleConnection (+17 more)
...
Cohesion: 0.07
Nodes (56): Code, RespError, PgName(), TestPgName_EmptySuffix_ReturnsBaseName(), TestPgName_WithSuffix_AppendsSuffix(), proto(), TestCreateSidecarContainerJob_Rollback_NotFoundIsSwallowed(), TestStartSidecarContainerJob_ContainerStartError() (+48 more)
...
Cohesion: 0.10
Nodes (12): AppConfig, ConfigMeta, ConfigurationPatch, ConfigFormat, ConfigTypePrefix, fromApiNodes(), Configurator, Context (+4 more)

### Community 82 - "internal/storage (service_dependencies.go)"
Cohesion: 0.19
Nodes (11): Custom, ClusterClients, Impl, App, Context, Pipeliner, NewPipeliner(), Duration (+3 more)
...
Cohesion: 0.16
Nodes (10): envContainer, pgStorage, Context, Pointer, NewContainer(), Context, NewPg(), EnvironmentsStorage (+2 more)
...
Cohesion: 0.18
Nodes (3): MessageState, BreakConnections, CreateSmerd
...
Cohesion: 0.07
Nodes (24): CopyToContainerOptions, CreateOptions, patchEnableStatefullDockerFields(), APIClient, Context, CreateResponse, EndpointSettings, ExecOptions (+16 more)
...
Cohesion: 0.11
Nodes (3): Message, GetServiceEnvironments_Request, GetServiceMetrics_Request
...
Cohesion: 0.12
Nodes (6): file_service_api_proto_init(), CreateDeploy_Request_Upgrade, init(), CreateDeploy_Request, isCreateDeploy_Request_Specification, ListServices

### Community 116 - "internal/api (Message)"
Cohesion: 0.05
Nodes (57): ControlPlaneAPI, EnableHeadscaleServer, EnablePluginResponse, EnableStatefullCluster, ListEnvironmentsResponse, VervPlugin, VervPluginState, VervPluginType (+49 more)
...
Cohesion: 0.09
Nodes (7): MessageState, SizeCache, UnknownFields, Container, Container_Hardware, Image, PlainConfigSpec
...
Cohesion: 0.07
Nodes (59): ConnectServiceToVpnTaskPayload, EnableStatefullTaskPayload, App, Checkpoint(), Context, TestCheckpoint_FailFastWhenFailed(), TestCheckpoint_RunsAndPersistsContextOnSuccess(), TestCheckpoint_SkipsWhenDone() (+51 more)
...
Cohesion: 0.08
Nodes (26): New(), NewTxManager(), Queries, newDeploymentsStorage(), Queries, newJobsStorage(), calculatePluginState(), Context (+18 more)
...
Cohesion: 0.12
Nodes (17): CreateDeployReq, GetServiceReq, RemoveServiceReq, UpgradeDeployReq, Context, VervService, TestCreateNewDeploy_GetByNameError(), TestUpgradeDeploy_GetByNameError() (+9 more)
...
Cohesion: 0.14
Nodes (6): Pointer, Storage, Querier, Container, JobsStorage, TasksStorage
...
Cohesion: 0.12
Nodes (4): SizeCache, CreateService_Response, GetVervonomicon, RestartService_Response

### Community 236 - "Volume"
Cohesion: 0.11
Nodes (4): UnknownFields, CreateService_Request, GetService, ListDeployments
...
Cohesion: 0.08
Nodes (19): VervClosedNetworkClient, Context, ServiceDiscovery, SetupMakosh(), CreateRequest, TailScaleContainerSidecar(), ConnectServiceToVpn(), ServiceDiscovery (+11 more)
...
### Community 373 - "ListEnvironments_Request"
Cohesion: 0.33
...
Cohesion: 0.17
Nodes (11): copyToContainerStep, FileMountPoint, SetupHeadscaleRequest, SetupHeadscaleResponse, BasicConfig(), CreateRequest, Headscale(), pipeliner (+3 more)
...
### Community 495 - "New"
Cohesion: 0.25
Nodes (5): staticStorage, Context, New(), Context, NewStatic()

### Community 496 - "RegisterServiceApiHandler"
Cohesion: 0.29
...
Cohesion: 0.07
Nodes (15): Context, Docker, assembleConfigHandler, copyToVolumeHandler, createServiceHandler, createSmerdHandler, dropContainerJob, dropResultAccessor (+7 more)
...
- **Why does `T` connect `internal/pipelines (ConnectServiceToVpn())` to `ListEnvironments_Response`, `internal/clients (hardware_manager.go)`, `pkg/web (index.ts)`, `internal/api (UnknownFields)`, `pkg/web (ControlPlanePage.tsx)`, `internal/storage (deployments)`, `ServicePageModel.ts`, `internal/storage (node.go)`, `tests/e2e (suite_hello_world_cluster_test.go)`, `internal/service (list_test.go)`, `internal/api (matreshka_common.pb.go)`, `internal/pipelines (do_copy_to_volume.go)`, `pkg/web (verv_closed_network.pb.ts)`, `tests/e2e (NewEnvironment())`, `Context`, `internal/api (UnknownFields)`, `.enrichServiceWithSmerdData`, `initKey`, `internal/api (CreateConfig_Request)`?**
  _High betweenness centrality (0.203) - this node is a cross-community bridge._
- **Why does `file_velez_common_proto_init()` connect `pkg/web (Sidebar.tsx)` to `internal/api (velez_api.pb.go)`, `internal/pipelines (get_root_dsn.go)`, `internal/api (control_plane_api.pb.go)`, `portManagerImpl`?**
