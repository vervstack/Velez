...
## Corpus Check
- 637 files · ~314,056 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 7332 nodes · 12892 edges · 741 communities (394 shown, 347 thin omitted)
- Extraction: 94% EXTRACTED · 6% INFERRED · 0% AMBIGUOUS · INFERRED: 786 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `0326803c`
...
- Container_Hardware
- .getLaunchConfig
- internal/transport (list_environments.go)
...
3. `newFakeDocker()` - 64 edges
4. `file_service_api_proto_rawDescGZIP()` - 50 edges
5. `useToaster` - 45 edges
6. `newFakeNodeClients()` - 44 edges
7. `newFakeContainerAPI()` - 42 edges
8. `file_control_plane_api_proto_rawDescGZIP()` - 40 edges
9. `proto()` - 34 edges
10. `file_velez_api_proto_rawDescGZIP()` - 32 edges
...
- **Velez Configuration Environment Variable Schema** — config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_config_configyaml, config_configtemplate, docs_configuration [INFERRED 0.90]
...
## Communities (741 total, 347 thin omitted)
...
Cohesion: 0.07
Nodes (34): connectToNetwork(), createNetworkIfMissing(), disconnectFromNetworks(), fromContainerNetwork(), ConfigTypePrefix, ContainerState, Context, CreateSmerd_Request (+26 more)

### Community 6 - "pkg/web (ServiceCard.tsx)"
Cohesion: 0.06
Nodes (47): Smerd, SmerdStatus, router, Arguments, AppCard(), AppCardProps, EnvChip(), EnvChipProps (+39 more)
...
Cohesion: 0.04
Nodes (21): fakeEnvProvider, Pointer, Pointer, Storage, Querier, envProvider, fakeClusterStorage, localStorage (+13 more)
...
Cohesion: 0.21
Nodes (10): Context, Docker, Volume, writeFileToContainer(), copyAPI, copyFileJob, copyToVolumeRequestAccessor, createLoaderContainerJob (+2 more)
...
Cohesion: 0.10
Nodes (41): TestCreateScratchContainerJob_ContainerCreateError(), TestCreateScratchContainerJob_Rollback_NoContainerId_NoOp(), TestCreateScratchContainerJob_Rollback_NotFoundIsSwallowed(), TestCreateScratchContainerJob_Rollback_RemoveErrorPropagates(), TestCreateScratchContainerJob_Rollback_RemovesContainer(), TestCreateScratchContainerJob_Success(), TestCreateSidecarContainerJob_ContainerCreateError(), TestCreateSidecarContainerJob_Rollback_NoContainerId_NoOp() (+33 more)
...
Cohesion: 0.09
Nodes (16): App, Context, Listener, New(), ServerOption, GrpcIncomingInterceptor(), ServerOption, LogInterceptor() (+8 more)
...
Cohesion: 0.07
Nodes (10): MessageState, SizeCache, UnknownFields, ConnectSlave, ConnectSlave_Request, DeleteEnvironment_Response, EnablePlugin, InitMaster_Response (+2 more)
...
Cohesion: 0.12
Nodes (22): TestFetchSmerdConfigJob_SetEnv_CallerValueNotOverwritten(), TestFetchSmerdConfigJob_VervAndPlain_BothApply(), newFakeConfigurationService(), newFakeContainerService(), realPortManager(), strPtr(), TestCaptureOldContainerJob_InspectError(), TestCaptureOldContainerJob_Success() (+14 more)
...
Cohesion: 0.06
Nodes (44): NodeBaseInfo, NodeStatus, useEnvironmentStore, MainLayout(), NAV_TO_ROUTE, NavId, ROUTE_TO_NAV, TOOL_TO_ROUTE (+36 more)
...
Cohesion: 0.04
Nodes (50): AssembleConfig, AssembleConfigRequest, AssembleConfigResponse, BreakConnections, BreakConnectionsRequest, BreakConnectionsResponse, CreateSmerd, DropSmerd (+42 more)

### Community 51 - "internal/pipelines (.UpgradeSmerd())"
Cohesion: 0.17
Nodes (18): fakeListDocker, ContainerManager, Context, Docker, ListSmerds_Request, Summary, newListManager(), TestListSmerds_DockerErrorPropagates() (+10 more)
...
Cohesion: 0.12
Nodes (18): ListServicesReq, Paging, Context, countTotal(), fromStorageToDomainService(), Context, Querier, SelectBuilder (+10 more)
...
Cohesion: 0.20
Nodes (6): firstNotEmptyKey(), Once, RWMutex, readStateFromPath(), writeKey(), Manager

### Community 63 - "pkg/web (fetch.pb.ts)"
Cohesion: 0.07
Nodes (20): ConnectServiceToVcn, GetVcnAuthKeyReq, IssueClientKey, ListVpnNamespaces, RegisterVcnNodeReq, SetupHeadscaleRequest, SetupHeadscaleResponse, VcnAuthKey (+12 more)
...
Cohesion: 0.03
Nodes (63): Environment, ServiceBaseInfo, EnvironmentStore, NOTE: this is unrelated to `ServiceEnvironment`, Toast, Toaster, useToaster, Button() (+55 more)
...
Cohesion: 0.08
Nodes (63): Code, PgName(), TestPgName_EmptySuffix_ReturnsBaseName(), TestPgName_WithSuffix_AppendsSuffix(), proto(), TestStartSidecarContainerJob_ContainerStartError(), TestStartSidecarContainerJob_NoContainerId_Error(), TestStartSidecarContainerJob_Rollback_StopsContainer() (+55 more)
...
Cohesion: 0.09
Nodes (4): Message, CreateService, CreateService_Response, RestartService_Response

### Community 73 - "tests/e2e (NewEnvironment())"
Cohesion: 0.04
Nodes (47): ControlPlaneSuite, EnableStatefullSuite, LifecycleSuite, StateOpt, TestEnvironment, TestEnvOpt, UpgradeSmerdSuite, VpnSuite (+39 more)
...
Cohesion: 0.20
Nodes (14): fakeVervServices, DeleteEnvironmentReq, Context, Environment, Test_CreateEnvironment_Error(), Test_CreateEnvironment_OmittedSuffixIsEmptyAtTransport(), Test_CreateEnvironment_PassesSuffixThrough(), Test_DeleteEnvironment_ById() (+6 more)

### Community 82 - "internal/storage (service_dependencies.go)"
Cohesion: 0.10
Nodes (22): Custom, ClusterClients, Impl, App, Context, smerdsDropper(), NewSecurityManager(), Container (+14 more)

### Community 83 - "internal/storage (EnvironmentsStorage)"
Cohesion: 0.11
Nodes (20): fetchConfigStep, getConfigFromContainerStep, copyToContainerStep, ConfigMount, FileMountPoint, Context, FileConfig, InspectResponse (+12 more)
...
Cohesion: 0.12
Nodes (4): MessageState, GetServiceEnvironments, GetVervonomicon_Response, RemoveService
...
Cohesion: 0.06
Nodes (31): LaunchSmerd, LaunchSmerdResult, CreateSmerd_Request, pipeliner, pipeliner, FetchConfig(), APIClient, Context (+23 more)
...
Cohesion: 0.06
Nodes (27): CopyToContainerOptions, CreateOptions, APIClient, Context, CreateResponse, EndpointSettings, ExecOptions, HostConfig (+19 more)
...
Cohesion: 0.43
Nodes (6): EnvironmentsProvider, APIClient, ContainerManager, Context, Docker, New()
...
Cohesion: 0.11
Nodes (13): CreateDeploymentParams, CreateSpecificationParams, GetSpecificationByIdRow, UpdateDeploymentStatusParams, Queries, Tx, Context, Queries (+5 more)
...
Cohesion: 0.12
Nodes (21): Context, CreateSmerd_Request, Handler, ServerStreamingServer, ServiceRegistrar, TaskStatus, TaskStatus_JobStatus, VelezJobStatus (+13 more)
...
Cohesion: 0.18
Nodes (15): keyIssuer, Context, Docker, issueNewAPIKey(), Connect(), ConnectToContainer(), getAPIAddress(), Context (+7 more)
...
Cohesion: 0.21
Nodes (13): Context, resolveEnvironmentSuffix(), newEnvProvider(), TestCreateContainerJob_StampsResolvedEnvironmentSuffix(), TestCreateContainerJob_UnknownEnvironmentFailsJob(), TestCreateSmerdTaskPayload_EnvironmentSurvivesRoundTrip(), TestDropSmerdTaskPayload_EnvironmentSurvivesRoundTrip(), TestResolveEnvironmentSuffix_EmptyNameIsUnscoped() (+5 more)
...
Cohesion: 0.07
Nodes (62): CopyToVolumeTaskPayload, EnableStatefullTaskPayload, App, Checkpoint(), Context, TestCheckpoint_FailFastWhenFailed(), TestCheckpoint_RunsAndPersistsContextOnSuccess(), TestCheckpoint_SkipsWhenDone() (+54 more)
...
Cohesion: 0.08
Nodes (23): New(), NewTxManager(), NewPg(), Queries, newDeploymentsStorage(), Queries, newJobsStorage(), newPluginsStorage() (+15 more)
...
Cohesion: 0.08
Nodes (18): AssembleConfigJobSuite, AssembleConfigSuite, HelloWorldClusterSuite, Context, runner[T], Context, Suite, Test_AssembleConfigJob() (+10 more)
...
Cohesion: 0.05
Nodes (24): AppConfig, ConfigMeta, ConfigurationPatch, ConfigFormat, ConfigTypePrefix, Configurator, MatreshkaBeAPI_SubscribeOnChangesClient, MatreshkaBeAPIClient (+16 more)
...
Cohesion: 0.09
Nodes (22): APIClient, Context, CreateSmerd_Request, Docker, EnvironmentsProvider, FileConfig, MatreshkaConfigSpec, copyToContainerJob (+14 more)
...
Cohesion: 0.12
Nodes (3): file_service_api_proto_rawDescGZIP(), GetVervonomicon_Request, StopService_Request
...
Cohesion: 0.06
Nodes (28): ClusterStateManagerContainer, Configurator, ServiceDiscovery, VervClosedNetworkClient, clusterClients, MakoshBeAPIClient, MatreshkaBeAPIClient, Client (+20 more)
...
Cohesion: 0.20
Nodes (8): FromVolume(), Container_Settings, Volume, ToVolume(), FromRestart(), RestartPolicy, HostConfig, Mount

### Community 259 - "New"
Cohesion: 0.12
Nodes (4): UnknownFields, GetService, GetVervonomicon, RemoveService_Response
...
Cohesion: 0.12
Nodes (4): SizeCache, CreateDeploy_Response, GetServiceMetrics, ListServices
...
Cohesion: 0.09
Nodes (4): Message, InitMaster, ListPlugins_Request, UpdateEnvironment
...
### Community 391 - ".getLaunchConfig"
Cohesion: 0.33
Nodes (5): HealthConfig, FromCommand(), FromHealthcheck(), Container_Healthcheck, StrSlice

### Community 394 - "internal/transport (list_environments.go)"
Cohesion: 0.33
...
Cohesion: 0.29
Nodes (4): Context, fakeEnvResolver, VervServicesService, fakeEnvResolver
...
Cohesion: 0.08
Nodes (29): AliveKeeper, AppInfo, Config, EnvironmentConfig, ServersConfig, SharedInstance, sharedInstanceCtxKey, Client (+21 more)
...
Cohesion: 0.08
Nodes (12): Context, Docker, Docker, assembleConfigHandler, copyToVolumeHandler, dropContainerJob, dropResultAccessor, dropSmerdHandler (+4 more)

### Community 552 - "ClusterStateManager"
Cohesion: 0.40
Nodes (3): ClusterStateManager, Storage, NewContainer()

### Community 614 - ".ListSmerds"
Cohesion: 0.40
...
### Community 680 - "ContainerStats"
Cohesion: 0.40
Nodes (4): BoundResource, ContainerStats, ServiceMetrics, Time

### Community 682 - "UpdateEnvironment"
Cohesion: 0.60
Nodes (3): CreateDeployReq, Context, fakeDeployService
...
## Knowledge Gaps
- **1080 isolated node(s):** `status.sh script`, `go.vervstack.ru/Velez`, `UnsafeMatreshkaApiServer`, `UnsafeControlPlaneAPIServer`, `UnsafeServiceApiServer` (+1075 more)
...
- **Why does `T` connect `internal/transport (grpcServer)` to `internal/clients (hardware_manager.go)`, `internal/api (CreateDeploy_Request)`, `pkg/web (index.ts)`, `internal/api (UnknownFields)`, `pkg/web (ControlPlanePage.tsx)`, `internal/storage (deployments)`, `tests/e2e (suite_hello_world_cluster_test.go)`, `internal/service (list_test.go)`, `internal/transport (deploy_list.go)`, `internal/pipelines (ConnectServiceToVpn())`, `internal/pipelines (do_copy_to_volume.go)`, `internal/pipelines (.UpgradeSmerd())`, `CreatePgUserForNode`, `UpsertPluginParams`, `pkg/web (verv_closed_network.pb.ts)`, `tests/e2e (NewEnvironment())`, `internal/pipelines (fetch_from_container.go)`, `internal/api (UnknownFields)`, `.enrichServiceWithSmerdData`, `initKey`, `internal/api (CreateConfig_Request)`, `pkg/web (DeploymentHistory.tsx)`?**
  _High betweenness centrality (0.220) - this node is a cross-community bridge._
- **Why does `file_velez_common_proto_init()` connect `ListEnvironments_Response` to `internal/api (velez_api.pb.go)`, `internal/api (control_plane_api.pb.go)`, `InitMaster_Response`, `pkg/web (package.json)`?**
  _High betweenness centrality (0.151) - this node is a cross-community bridge._
- **Why does `b64Decode()` connect `internal/pipelines (do_copy_to_volume.go)` to `internal/transport (grpcServer)`?**
  _High betweenness centrality (0.127) - this node is a cross-community bridge._
- **Are the 62 inferred relationships involving `newFakeDocker()` (e.g. with `TestCreateScratchContainerJob_ContainerCreateError()` and `TestCreateScratchContainerJob_Rollback_NoContainerId_NoOp()`) actually correct?**
  _`newFakeDocker()` has 62 INFERRED edges - model-reasoned connections that need verification._
